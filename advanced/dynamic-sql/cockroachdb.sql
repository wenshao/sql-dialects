-- CockroachDB: Dynamic SQL
--
-- 参考资料:
--   [1] CockroachDB Documentation - PREPARE
--       https://www.cockroachlabs.com/docs/stable/prepare.html
--   [2] CockroachDB Documentation - EXECUTE
--       https://www.cockroachlabs.com/docs/stable/execute.html
--   [3] CockroachDB Documentation - PL/pgSQL
