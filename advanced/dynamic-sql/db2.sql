...
--
-- 参考资料:
--   [1] IBM DB2 Documentation - EXECUTE IMMEDIATE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-execute-immediate
--   [2] IBM DB2 Documentation - PREPARE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-prepare
--   [3] IBM DB2 Documentation - Dynamic SQL
--       https://www.ibm.com/docs/en/db2/11.5?topic=programming-dynamic-sql
