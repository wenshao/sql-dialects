...
--   [2] Apache Derby Developer's Guide - Dynamic SQL
--       https://db.apache.org/derby/docs/10.16/devguide/
--   [3] Apache Derby Tools Guide - ij Tool
--       https://db.apache.org/derby/docs/10.16/tools/
--   [4] JDBC PreparedStatement API
