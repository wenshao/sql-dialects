...
> 参考资料:
> - [DuckDB Documentation - Prepared Statements](https://duckdb.org/docs/sql/query_syntax/prepared_statements)
> - [DuckDB Documentation - Python API](https://duckdb.org/docs/api/python/overview)
