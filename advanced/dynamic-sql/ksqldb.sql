...
--
-- 参考资料:
--   [1] ksqlDB Documentation - ksqlDB Reference
--       https://docs.ksqldb.io/en/latest/developer-guide/ksqldb-reference/
--   [2] ksqlDB Documentation - REST API
--       https://docs.ksqldb.io/en/latest/developer-guide/api/
--   [3] ksqlDB Documentation - Java Client
--       https://docs.ksqldb.io/en/latest/developer-guide/java-client/
--   [4] ksqlDB Documentation - Security
--       https://docs.ksqldb.io/en/latest/operate-and-deploy/security/
