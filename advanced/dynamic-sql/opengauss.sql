...
--
-- 参考资料:
--   [1] openGauss Documentation - PL/pgSQL
--       https://docs.opengauss.org/en/docs/latest/docs/DeveloperGuide/pl-pgsql.html
--   [2] openGauss Documentation - EXECUTE IMMEDIATE
--       https://docs.opengauss.org/en/docs/latest/docs/DeveloperGuide/dynamic-statements.html
