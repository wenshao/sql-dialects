...
--
-- 参考资料:
--   [1] Teradata SQL Reference - Dynamic SQL
--       https://docs.teradata.com/r/Teradata-Database-SQL-Stored-Procedures-and-Embedded-SQL/
--   [2] Teradata SQL Reference - EXECUTE / EXECUTE IMMEDIATE
