-- YugabyteDB: Dynamic SQL
--
-- 参考资料:
--   [1] YugabyteDB Documentation - PREPARE
--       https://docs.yugabyte.com/preview/api/ysql/the-sql-language/statements/perf_prepare/
--   [2] YugabyteDB Documentation - PL/pgSQL
