...
--
-- 参考资料:
--   [1] IBM DB2 Documentation - DECLARE HANDLER
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-declare-handler
--   [2] IBM DB2 Documentation - SIGNAL
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-signal
--   [3] IBM DB2 Documentation - GET DIAGNOSTICS
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-get-diagnostics
