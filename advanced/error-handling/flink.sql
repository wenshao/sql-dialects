-- Apache Flink SQL: 错误处理 (Error Handling)
--
-- 参考资料:
--   [1] Apache Flink Documentation - SQL Reference
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/overview/
--   [2] Apache Flink Documentation - Fault Tolerance
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/ops/state/fault_tolerance/
--   [3] Apache Flink Documentation - Restart Strategies
