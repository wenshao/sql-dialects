-- PostgreSQL: 错误处理 (Error Handling)
--
-- 参考资料:
--   [1] PostgreSQL Documentation - PL/pgSQL Error Trapping
--       https://www.postgresql.org/docs/current/plpgsql-control-structures.html#PLPGSQL-ERROR-TRAPPING
--   [2] PostgreSQL Documentation - Error Codes
--       https://www.postgresql.org/docs/current/errcodes-appendix.html

-- ============================================================
-- 1. EXCEPTION WHEN: PL/pgSQL 异常捕获
-- ============================================================
...
-- ============================================================
-- 2. EXCEPTION 块的内部实现: 隐式 SAVEPOINT
-- ============================================================
...
-- ============================================================
-- 4. GET STACKED DIAGNOSTICS: 获取异常详情 (9.2+)
-- ============================================================
