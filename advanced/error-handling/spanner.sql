-- Google Cloud Spanner: 错误处理 (Error Handling)
--
-- 参考资料:
--   [1] Cloud Spanner Documentation - Error Codes
--       https://cloud.google.com/spanner/docs/reference/errors
--   [2] Cloud Spanner Documentation - Transactions
--       https://cloud.google.com/spanner/docs/transactions
--   [3] Cloud Spanner Documentation - SQL Reference
