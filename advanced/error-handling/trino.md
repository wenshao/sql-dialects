...
> 参考资料:
> - [Trino Documentation - Error Codes](https://trino.io/docs/current/admin/failure-tolerance.html)
> - [Trino Documentation - Built-in Functions (TRY)](https://trino.io/docs/current/functions/conditional.html#try)
