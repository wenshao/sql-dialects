...
--
-- 参考资料:
--   [1] IBM Documentation - EXPLAIN statement
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-explain
--   [2] IBM Documentation - db2expln
--       https://www.ibm.com/docs/en/db2/11.5?topic=commands-db2expln
--   [3] IBM Documentation - Explain tables
--       https://www.ibm.com/docs/en/db2/11.5?topic=tools-explain-tables
