...
--
-- 参考资料:
--   [1] openGauss Documentation - EXPLAIN
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/EXPLAIN.html
--   [2] openGauss Documentation - Performance Tuning
--       https://docs.opengauss.org/zh/docs/latest/docs/PerformanceTuningGuide/
