-- Google Cloud Spanner: 执行计划与查询分析
--
-- 参考资料:
--   [1] Spanner Documentation - Query execution plans
--       https://cloud.google.com/spanner/docs/query-execution-plans
--   [2] Spanner Documentation - Query statistics
--       https://cloud.google.com/spanner/docs/query-statistics-tables
...
-- 1. 使用 Interleaved Tables 减少 Distributed Union
-- 2. 使用二级索引避免全表扫描
-- 3. 使用 FORCE_INDEX Hint
