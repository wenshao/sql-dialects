...
--
-- 参考资料:
--   [1] Teradata Documentation - EXPLAIN
--       https://docs.teradata.com/r/Teradata-Database-SQL-Data-Manipulation-Language/June-2017/EXPLAIN
--   [2] Teradata Documentation - Query Performance
--       https://docs.teradata.com/r/Teradata-VantageTM-SQL-Request-and-Transaction-Processing
