...
--
-- 参考资料:
--   [1] 达梦数据库 SQL 语言参考 - 锁管理
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/sql-lock.html
--   [2] 达梦数据库 SQL 语言参考 - SELECT FOR UPDATE
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-select.html
--   [3] 达梦数据库 SQL 语言参考 - 事务管理
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/sql-transaction.html
...
-- 1. 兼容 Oracle 的锁语法
-- 2. 支持 SELECT FOR UPDATE / NOWAIT / WAIT / SKIP LOCKED
-- 3. 支持 LOCK TABLE
-- 4. MVCC 实现并发控制
-- 5. 与 Oracle 类似，读不阻塞写
