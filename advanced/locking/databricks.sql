...
--
-- 参考资料:
--   [1] Databricks Documentation - Isolation Levels and Write Conflicts on Databricks
--       https://docs.databricks.com/en/optimizations/isolation-level.html
--   [2] Databricks Documentation - Delta Lake Transaction Log
--       https://docs.databricks.com/en/delta/history.html
--   [3] Delta Lake Documentation - Concurrency Control
