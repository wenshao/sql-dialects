...
--
-- 参考资料:
--   [1] Firebird Documentation - Concurrency and Locking
--       https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html
--   [2] Firebird Documentation - Transaction Management
--       https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-transacs
--   [3] Firebird Documentation - WITH LOCK
--       https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-dml-select-withlockclause
...
-- 1. Firebird 不支持 LOCK TABLE 语句
-- 2. 使用 WITH LOCK 代替 FOR UPDATE
-- 3. MVCC (MGA) 提供高并发读
-- 4. 不支持 advisory locks
-- 5. 需要定期 sweep 清理旧版本数据
