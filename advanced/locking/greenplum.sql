...
--
-- 参考资料:
--   [1] Greenplum Documentation - Managing Data
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/admin_guide-intro-about_mvcc.html
--   [2] Greenplum Documentation - LOCK
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-sql_commands-LOCK.html
--   [3] Greenplum Documentation - pg_locks
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-system_catalogs-pg_locks.html
