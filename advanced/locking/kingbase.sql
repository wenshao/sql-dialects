...
--
-- 参考资料:
--   [1] KingbaseES 文档 - 并发控制
--       https://help.kingbase.com.cn/v8/development/sql-plsql/sql/SQL_statements_9.html
--   [2] KingbaseES 文档 - LOCK
--       https://help.kingbase.com.cn/v8/development/sql-plsql/sql/SQL_statements_10.html
...
-- 1. 基于 PostgreSQL，兼容 PostgreSQL 锁语法
-- 2. 支持全部 PostgreSQL 锁模式
-- 3. 支持 advisory locks
-- 4. 支持 NOWAIT / SKIP LOCKED
-- 5. 同时支持 Oracle 兼容模式
