...
--
-- 参考资料:
--   [1] ksqlDB Documentation - Concepts
--       https://docs.ksqldb.io/en/latest/concepts/
--   [2] ksqlDB Documentation - Processing Guarantees
--       https://docs.ksqldb.io/en/latest/operate-and-deploy/exactly-once-semantics/
...
-- 3. 不支持 LOCK TABLE
-- 4. 并发通过 Kafka 分区并行处理
-- 5. 一致性通过 Kafka exactly-once 语义保证
-- 6. pull query 读取物化视图的最新状态
-- 7. push query 持续推送更新
