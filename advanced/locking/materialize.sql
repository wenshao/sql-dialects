...
--
-- 参考资料:
--   [1] Materialize Documentation - Transactions
--       https://materialize.com/docs/sql/begin/
--   [2] Materialize Documentation - Architecture
--       https://materialize.com/docs/overview/architecture/
...
-- 4. 写入通过 Sources 和 Sinks 进行
-- 5. 不支持 INSERT/UPDATE/DELETE（传统 DML）
-- 6. 物化视图自动增量更新，无需锁定
-- 7. 适合实时分析和流处理场景
