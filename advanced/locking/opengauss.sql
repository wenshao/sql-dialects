...
-- 参考资料:
--   [1] openGauss 文档 - 并发控制
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/LOCK.html
--   [2] openGauss 文档 - SELECT FOR UPDATE
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/SELECT.html
--   [3] openGauss 文档 - pg_locks
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/PG_LOCKS.html
...
-- 1. 基于 PostgreSQL 9.2，兼容 PostgreSQL 锁语法
-- 2. 支持 advisory locks
-- 3. 支持 NOWAIT / SKIP LOCKED
-- 4. 华为开源数据库，兼容 PostgreSQL 生态
