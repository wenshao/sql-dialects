...
> 参考资料:
> - [SQL Server - Locking and Row Versioning Guide](https://learn.microsoft.com/en-us/sql/relational-databases/sql-server-transaction-locking-and-row-versioning-guide)

## 锁提示系统: SQL Server 最独特的并发控制机制
...
## 行级锁: SELECT FOR UPDATE 的 SQL Server 等价
