...
--
-- 参考资料:
--   [1] Teradata Documentation - Locking
--       https://docs.teradata.com/r/Teradata-Database-SQL-Request-and-Transaction-Processing/Locking
--   [2] Teradata Documentation - LOCKING Modifier
--       https://docs.teradata.com/r/Teradata-Database-SQL-Data-Manipulation-Language/LOCKING-Modifier
--   [3] Teradata Documentation - Lock Logger
--       https://docs.teradata.com/r/Teradata-Database-Administration/Lock-Logger-Utility
