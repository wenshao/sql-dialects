...
--
-- 参考资料:
--   [1] IBM Documentation - Range-Partitioned Tables
--       https://www.ibm.com/docs/en/db2/11.5?topic=tables-range-partitioned
--   [2] IBM Documentation - Multidimensional Clustering
--       https://www.ibm.com/docs/en/db2/11.5?topic=tables-multidimensional-clustering
