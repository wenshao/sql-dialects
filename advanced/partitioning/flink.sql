...
--
-- 参考资料:
--   [1] Flink Documentation - Partitions
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/alter/#add-partition
--   [2] Flink Documentation - Filesystem Connector
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/filesystem/
