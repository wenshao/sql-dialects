-- Oracle: 表分区策略（Oracle 分区功能是业界最丰富的）
--
-- 参考资料:
--   [1] Oracle VLDB and Partitioning Guide
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/vldbg/
--   [2] Oracle SQL Language Reference - CREATE TABLE (Partitioning)
...
-- 9. 对引擎开发者的总结
-- ============================================================
-- 1. Oracle 分区功能最丰富: RANGE/LIST/HASH/INTERVAL/REFERENCE/复合分区。
...
-- 5. LOCAL vs GLOBAL 索引是分区表设计中最关键的权衡:
