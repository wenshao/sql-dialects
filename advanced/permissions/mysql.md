...
> - [MySQL 8.0 Reference Manual - Partial Revokes](https://dev.mysql.com/doc/refman/8.0/en/partial-revokes.html)
...
## user@host 权限模型: MySQL 的独特设计（对引擎开发者）
...
## 8.0+ 角色 (Roles) 和部分撤销 (Partial Revokes)
...
### PostgreSQL: RBAC (Role-Based Access Control)
...
### Oracle: 传统 RBAC + Fine-Grained Access Control
...
### 云数据库: IAM (Identity and Access Management)
