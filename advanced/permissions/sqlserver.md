...
> 参考资料:
> - [SQL Server - Security](https://learn.microsoft.com/en-us/sql/relational-databases/security/authentication-access/getting-started-with-database-engine-permissions)

## Login/User 双层模型（详见 users-databases 章节）
...
## 动态数据掩码（Dynamic Data Masking, 2016+）
