...
> - [MySQL 8.0 Reference Manual - CREATE FUNCTION](https://dev.mysql.com/doc/refman/8.0/en/create-function.html)
> - [MySQL 8.0 Reference Manual - Stored Program Syntax](https://dev.mysql.com/doc/refman/8.0/en/sql-compound-statements.html)
> - [MySQL 8.0 Reference Manual - Cursor](https://dev.mysql.com/doc/refman/8.0/en/cursors.html)
...
## MySQL 存储过程的局限性（对 SQL 引擎开发者）

### DELIMITER: MySQL 最大的语法尴尬
...
### 语言能力对比: MySQL SP vs Oracle PL/SQL vs PG PL/pgSQL
...
## 横向对比: 存储过程 vs 应用层逻辑 vs UDF（对 SQL 引擎开发者）
...
### UDF（User-Defined Function）的设计选择:
