...
> - [Oracle SQL Language Reference - CREATE PROCEDURE](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/CREATE-PROCEDURE.html)
...
## 包（Package，Oracle PL/SQL 的核心架构模式）
...
## BULK COLLECT + FORALL（Oracle PL/SQL 性能核心）
...
## 自治事务（Autonomous Transaction，Oracle 独有）
