...
--
-- 参考资料:
--   [1] IBM Documentation - DECLARE GLOBAL TEMPORARY TABLE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-declare-global-temporary-table
--   [2] IBM Documentation - CREATE GLOBAL TEMPORARY TABLE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-create-global-temporary-table
