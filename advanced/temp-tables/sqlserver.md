...
> 参考资料:
> - [SQL Server - Temporary Tables](https://learn.microsoft.com/en-us/sql/t-sql/statements/create-table-transact-sql#temporary-tables)
> - [SQL Server - Table Variables](https://learn.microsoft.com/en-us/sql/t-sql/data-types/table-transact-sql)
