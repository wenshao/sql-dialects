...
--
-- 参考资料:
--   [1] Oracle SQL Language Reference - COMMIT / ROLLBACK / SAVEPOINT
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/COMMIT.html
--   [2] Oracle Database Concepts - Transactions
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/cncpt/transactions.html
--   [3] Oracle PL/SQL Language Reference - AUTONOMOUS_TRANSACTION
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/lnpls/AUTONOMOUS_TRANSACTION-pragma.html
...
-- 1. 闪回查询 (9i+): 查看过去某时刻的数据
SELECT * FROM accounts
AS OF TIMESTAMP (SYSTIMESTAMP - INTERVAL '1' HOUR);

-- 2. 闪回版本查询 (10g+): 查看行的所有版本变更
SELECT id, balance,
       VERSIONS_STARTTIME,
       VERSIONS_ENDTIME,
...
-- 1. COMMIT 的 WRITE 选项 (10gR2+): 控制日志刷新行为
