...
--   [2] MySQL 8.0 Reference Manual - Trigger Syntax and Examples
--       https://dev.mysql.com/doc/refman/8.0/en/trigger-syntax.html
--   [3] MySQL 8.0 Reference Manual - Trigger Restrictions
...
-- ============================================================
-- 4. 横向对比: 触发器 vs CDC vs 物化视图（事件驱动方案）
-- ============================================================
...
-- 4.2 CDC（Change Data Capture）方案
