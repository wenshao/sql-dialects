...
> 参考资料:
> - [Oracle SQL Language Reference - CREATE TRIGGER](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/CREATE-TRIGGER.html)
> - [Oracle PL/SQL Language Reference - Triggers](https://docs.oracle.com/en/database/oracle/oracle-database/23/lnpls/plsql-triggers.html)
