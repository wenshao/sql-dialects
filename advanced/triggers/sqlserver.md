...
> 参考资料:
> - [SQL Server T-SQL - CREATE TRIGGER](https://learn.microsoft.com/en-us/sql/t-sql/statements/create-trigger-transact-sql)

## DML 触发器: AFTER 和 INSTEAD OF
...
## INSTEAD OF 触发器（SQL Server 独有能力: 可用在表上）
