...
--   [2] MySQL 8.0 Reference Manual - Online DDL Operations
--       https://dev.mysql.com/doc/refman/8.0/en/innodb-online-ddl-operations.html
--   [3] Percona pt-online-schema-change
...
-- ============================================================
-- 2. Online DDL 算法详解（对 SQL 引擎开发者）
-- ============================================================

-- 2.1 三种算法: COPY / INPLACE / INSTANT
--
...
-- ============================================================
-- 3. pt-online-schema-change 和 gh-ost（对引擎开发者）
-- ============================================================
...
-- 3.2 pt-online-schema-change 原理（Percona Toolkit）
...
-- 3.3 gh-ost 原理（GitHub Online Schema Transmogrifier）
