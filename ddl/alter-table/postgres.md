...
> - [PostgreSQL Source - ATExecCmd / AlterTableGetLockLevel](https://github.com/postgres/postgres/blob/master/src/backend/commands/tablecmds.c)
...
## NOT VALID + VALIDATE CONSTRAINT: 大表加约束的最佳实践
