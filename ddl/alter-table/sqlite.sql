...
--   [2] SQLite Internals - File Format (table schema stored in sqlite_master)
--       https://www.sqlite.org/fileformat2.html
--   [3] SQLite Documentation - CREATE TABLE (for rebuild approach)
...
-- ============================================================
-- 2. 为什么 ALTER TABLE 如此受限（对引擎开发者）
-- ============================================================

-- 2.1 SQLite 的 schema 存储模型
...
-- 2.3 DROP COLUMN 为何到 3.35.0 才支持（2021年3月）
...
-- ============================================================
-- 3. 重建表模式: SQLite 的 ALTER TABLE 替代方案
-- ============================================================
...
-- ============================================================
-- 5. schema 版本管理（对引擎开发者）
-- ============================================================

-- 5.1 user_version PRAGMA: 应用层 schema 版本追踪
...
-- 6. 版本演进
-- ============================================================
-- 3.0  (2004): 基本 ALTER TABLE（RENAME TABLE, ADD COLUMN）
-- 3.25 (2018): RENAME COLUMN（等了 14 年）
-- 3.35 (2021): DROP COLUMN（等了 17 年）
-- 3.37 (2021): STRICT 表模式
--
-- 未支持（且可能永远不会支持）:
