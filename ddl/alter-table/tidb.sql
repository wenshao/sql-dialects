...
-- 2.1 TiDB Online DDL: 分布式环境下的 Schema 变更
...
-- ============================================================
-- 3. TiDB 特有的 ALTER TABLE 操作
-- ============================================================

-- 3.1 设置 TiFlash 副本（HTAP 核心操作）
