...
--
-- 参考资料:
--   [1] Trino Documentation - ALTER TABLE
--       https://trino.io/docs/current/sql/alter-table.html

-- ============================================================
-- 1. 基本语法（能力取决于 Connector）
-- ============================================================
-- 添加列
...
-- 2.1 ALTER TABLE 的 Connector 依赖性
...
-- 2.2 Iceberg Connector: Schema Evolution 最强
...
-- 2.4 Iceberg 分区演进（Partition Evolution）
