...
--   [3] DamengDB SQL 语言手册 - 约束
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/chapter08-constraints.html
--   [4] Oracle Database Constraints Documentation
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/adfns/constraints.html
...
-- NOVALIDATE: 只检查新数据，不检查历史数据
-- 用途: 历史数据有不合规数据但新数据需要约束
...
-- ALTER TABLE users DISABLE CONSTRAINT pk_users KEEP INDEX;  -- 保留索引
