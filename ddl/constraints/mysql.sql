...
--   [3] MySQL 8.0 Reference Manual - FOREIGN KEY Constraints
--       https://dev.mysql.com/doc/refman/8.0/en/create-table-foreign-keys.html
--   [4] MySQL 8.0 Reference Manual - Constraint Enforcement
...
-- ============================================================
-- 2. CHECK 约束的历史: 一个著名的设计教训（对 SQL 引擎开发者）
-- ============================================================
...
-- ============================================================
-- 3. 外键的性能影响和分布式困境（对 SQL 引擎开发者）
-- ============================================================

-- 3.1 外键在单机 InnoDB 中的开销
