...
> 参考资料:
> - [Oracle SQL Language Reference - Constraints](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/constraint.html)
...
## 约束设计决策分析（对 SQL 引擎开发者）

### ON DELETE vs ON UPDATE: Oracle 的不完整外键支持
...
### ENABLE / DISABLE / VALIDATE / NOVALIDATE: 约束状态矩阵
