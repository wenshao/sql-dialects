...
> 参考资料:
> - [PolarDB-X SQL Reference - Constraints](https://help.aliyun.com/zh/polardb/polardb-for-xscale/sql-reference/)
...
## GSI 的 UNIQUE 约束用于替代 "唯一约束必须含分区键" 的限制

## 外键只用在同分片表之间，跨分片用应用层保证

## CHECK 约束对分布式透明，尽量利用

## GSI 的写入开销需要在查询性能和数据写入吞吐之间权衡
