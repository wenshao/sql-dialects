...
> 参考资料:
> - [SQL Server T-SQL - Table Constraints](https://learn.microsoft.com/en-us/sql/t-sql/statements/alter-table-table-constraint-transact-sql)
> - [SQL Server T-SQL - WITH NOCHECK](https://learn.microsoft.com/en-us/sql/t-sql/statements/alter-table-transact-sql)
...
## WITH NOCHECK: SQL Server 独有的约束信任机制
