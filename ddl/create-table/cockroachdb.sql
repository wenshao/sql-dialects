-- CockroachDB: CREATE TABLE (v23.2+)
--
-- 参考资料:
--   [1] CockroachDB - CREATE TABLE
--       https://www.cockroachlabs.com/docs/stable/create-table
--   [2] CockroachDB - Multi-Region
--       https://www.cockroachlabs.com/docs/stable/multiregion-overview
--   [3] CockroachDB - Architecture
...
-- 2.2 HASH-SHARDED INDEX: 解决顺序写入热点
...
-- 2.3 Column Families: 列族存储优化（CockroachDB 独有）
