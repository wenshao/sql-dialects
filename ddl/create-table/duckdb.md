...
> - [DuckDB Documentation - Data Import](https://duckdb.org/docs/data/overview)
...
### PostgreSQL 兼容语法: DuckDB 的核心设计选择
...
### 无 AUTO_INCREMENT / SERIAL: 嵌入式 OLAP 的选择
...
### 无 ON UPDATE 触发器: 无 updated_at 自动更新
