...
> 参考资料:
> - [Flink SQL - CREATE TABLE](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/create/)
...
## Changelog 语义: Flink 的核心设计（对引擎开发者关键）
...
## 横向对比: Flink vs 其他引擎的 CREATE TABLE
