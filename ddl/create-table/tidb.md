...
> 参考资料:
> - [TiDB SQL Reference - CREATE TABLE](https://docs.pingcap.com/tidb/stable/sql-statement-create-table)
...
### CLUSTERED vs NONCLUSTERED 主键（5.0+）
...
## 横向对比: TiDB vs 其他分布式引擎的 CREATE TABLE
