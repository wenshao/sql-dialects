...
> - [MySQL 8.0 Reference Manual - InnoDB Indexes](https://dev.mysql.com/doc/refman/8.0/en/innodb-index-types.html)
...
### 语义: 优化器忽略该索引（不用于查询计划），但 InnoDB 仍然维护它
...
### 绕过不可见: 会话级 optimizer switch 可以强制使用不可见索引
