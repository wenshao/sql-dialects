...
--   [2] Oracle Database Concepts - Indexes and Index-Organized Tables
...
-- ============================================================
-- 2. Oracle 独有索引类型（对引擎开发者的核心价值）
-- ============================================================

-- 2.1 位图索引（Bitmap Index）
