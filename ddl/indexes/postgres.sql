-- PostgreSQL: 索引 (Indexes)
--
-- 参考资料:
--   [1] PostgreSQL Documentation - Indexes
--       https://www.postgresql.org/docs/current/indexes.html
--   [2] PostgreSQL Source - nbtree, gin, gist, brin
...
-- 2.2 部分索引（Partial Index）—— 只索引满足条件的行
...
-- 2.3 INCLUDE 列（11+）—— Index-Only Scan 覆盖列
...
-- ============================================================
-- 4. CREATE INDEX CONCURRENTLY 的实现机制
-- ============================================================
...
-- ============================================================
-- 5. Index-Only Scan vs Index Scan vs Bitmap Scan
-- ============================================================
