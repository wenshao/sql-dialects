...
--
-- 参考资料:
--   [1] MySQL 8.0 Reference Manual - AUTO_INCREMENT Handling in InnoDB
--       https://dev.mysql.com/doc/refman/8.0/en/innodb-auto-increment-handling.html
--   [2] MySQL 8.0 Reference Manual - AUTO_INCREMENT
--       https://dev.mysql.com/doc/refman/8.0/en/example-auto-increment.html
--   [3] MySQL 8.0 Reference Manual - UUID Functions
--       https://dev.mysql.com/doc/refman/8.0/en/miscellaneous-functions.html#function_uuid

-- ============================================================
-- 1. AUTO_INCREMENT 基本语法
-- ============================================================
...
-- ============================================================
-- 2. AUTO_INCREMENT 的实现细节和锁模式（对 SQL 引擎开发者）
-- ============================================================

-- 2.1 自增锁模式: innodb_autoinc_lock_mode
...
-- ============================================================
-- 3. 为什么 MySQL 没有 SEQUENCE 对象（对 SQL 引擎开发者）
-- ============================================================
...
-- ============================================================
-- 4. 横向对比: AUTO_INCREMENT vs SERIAL vs IDENTITY vs SEQUENCE
-- ============================================================

-- 4.1 MySQL AUTO_INCREMENT:
--   语法:      id BIGINT AUTO_INCREMENT
--   特点:      表级绑定，每表一个，步长全局设置
--   持久化:    8.0+ 持久化到 redo log
--   分布式:    单机语义，分布式需要额外协调

-- 4.2 PostgreSQL SERIAL / IDENTITY:
--   SERIAL（旧方式，PG 所有版本）:
...
-- 4.4 SQL Server IDENTITY / SEQUENCE:
--   IDENTITY（传统，所有版本）:
