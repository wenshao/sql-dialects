-- Google Cloud Spanner: Sequences & Auto-Increment
--
-- 参考资料:
--   [1] Spanner Documentation - CREATE SEQUENCE
--       https://cloud.google.com/spanner/docs/reference/standard-sql/data-definition-language#create_sequence
--   [2] Spanner Documentation - Primary Keys & Unique IDs
--       https://cloud.google.com/spanner/docs/schema-design#primary-key-prevent-hotspots
--   [3] Spanner Documentation - Bit-reversed Sequences
--       https://cloud.google.com/spanner/docs/reference/standard-sql/data-definition-language#bit_reversed_positive
...
-- ============================================
-- 1. UUID（推荐）：分布均匀，无热点
-- 2. 位反转序列：数值型但分布均匀，适合需要整数 ID 的场景
-- 3. 严禁使用单调递增 ID 作为主键（性能灾难）
-- 4. Spanner 的核心约束：主键分布必须均匀
