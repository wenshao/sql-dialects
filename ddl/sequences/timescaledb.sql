...
--   [2] TimescaleDB Documentation - CREATE TABLE / Hypertable
...
-- 序列 vs 自增 权衡
-- ============================================
-- 1. 时序数据通常以时间戳为主键，不需要自增 ID
-- 2. GENERATED AS IDENTITY：需要数值 ID 时的推荐方式
-- 3. SERIAL/BIGSERIAL：兼容旧 PostgreSQL 代码
-- 4. UUID：适合分布式场景
-- 5. TimescaleDB 完全继承 PostgreSQL 的序列功能
