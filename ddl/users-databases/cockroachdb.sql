-- CockroachDB: 数据库、模式与用户管理
--
-- 参考资料:
--   [1] CockroachDB Documentation - CREATE DATABASE
--       https://www.cockroachlabs.com/docs/stable/create-database
--   [2] CockroachDB Documentation - CREATE USER / ROLE
