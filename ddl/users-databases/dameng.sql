...
--
-- 参考资料:
--   [1] 达梦数据库 SQL 参考手册 - CREATE USER
--       https://eco.dameng.com/docs/zh-cn/sql-dev/dmpl-sql/create-user.html
--   [2] 达梦数据库 SQL 参考手册 - 用户与权限
--       https://eco.dameng.com/docs/zh-cn/sql-dev/dmpl-sql/grant.html
