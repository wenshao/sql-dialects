...
--
-- 参考资料:
--   [1] IBM Db2 Documentation - CREATE DATABASE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-create-database
--   [2] IBM Db2 Documentation - GRANT / REVOKE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-grant
