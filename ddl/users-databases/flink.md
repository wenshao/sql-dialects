...
> 参考资料:
> - [Apache Flink Documentation - CREATE DATABASE](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/create/#create-database)
> - [Apache Flink Documentation - CREATE CATALOG](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/create/#create-catalog)
...
它是计算引擎，不是数据库
安全性依赖：
## 底层存储系统的权限（Hive, Kafka, etc.）

## Flink 集群的安全配置（Kerberos）

## Flink SQL Gateway 的认证
