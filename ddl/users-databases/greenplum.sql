...
--
-- 参考资料:
--   [1] Greenplum Documentation - CREATE DATABASE
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-sql_commands-CREATE_DATABASE.html
--   [2] Greenplum Documentation - Managing Roles and Privileges
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/admin_guide-roles_privs.html
