...
--
-- 参考资料:
--   [1] openGauss Documentation - CREATE DATABASE
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/CREATE-DATABASE.html
--   [2] openGauss Documentation - CREATE USER
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/CREATE-USER.html
