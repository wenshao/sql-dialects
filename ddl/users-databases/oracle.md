...
> 参考资料:
> - [Oracle SQL Language Reference - CREATE USER](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/CREATE-USER.html)
> - [Oracle Database Concepts - CDB and PDBs](https://docs.oracle.com/en/database/oracle/oracle-database/23/cncpt/CDBs-and-PDBs.html)
