-- Cloud Spanner: 数据库、模式与用户管理
--
-- 参考资料:
--   [1] Cloud Spanner Documentation - DDL
--       https://cloud.google.com/spanner/docs/reference/standard-sql/data-definition-language
--   [2] Cloud Spanner Documentation - IAM
