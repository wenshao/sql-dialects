...
> 参考资料:
> - [Microsoft Docs - CREATE DATABASE (Synapse)](https://learn.microsoft.com/en-us/sql/t-sql/statements/create-database-transact-sql?view=azure-sqldw-latest)
> - [Microsoft Docs - Synapse SQL Access Control](https://learn.microsoft.com/en-us/azure/synapse-analytics/sql/access-control)
