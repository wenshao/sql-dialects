...
--
-- 参考资料:
--   [1] TDengine Documentation - CREATE DATABASE
--       https://docs.taosdata.com/reference/sql/database/
--   [2] TDengine Documentation - User Management
--       https://docs.taosdata.com/reference/sql/user/
