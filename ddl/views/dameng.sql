...
--
-- 参考资料:
--   [1] 达梦数据库 SQL 语言参考 - CREATE VIEW
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-view.html
--   [2] 达梦数据库 SQL 语言参考 - 物化视图
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-mview.html
...
WHERE age >= 18
WITH CHECK OPTION;
-- 通过视图 INSERT/UPDATE 时，自动检查 WHERE 条件
