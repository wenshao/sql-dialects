...
--
-- 参考资料:
--   [1] Databricks SQL Reference - CREATE VIEW
--       https://docs.databricks.com/sql/language-manual/sql-ref-syntax-ddl-create-view.html
--   [2] Databricks Documentation - Materialized Views
--       https://docs.databricks.com/sql/language-manual/sql-ref-syntax-ddl-create-materialized-view.html
--   [3] Databricks Documentation - Streaming Tables
--       https://docs.databricks.com/sql/language-manual/sql-ref-syntax-ddl-create-streaming-table.html
