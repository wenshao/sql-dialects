...
--
-- 参考资料:
--   [1] Apache Derby 10.16 Reference - CREATE VIEW
--       https://db.apache.org/derby/docs/10.16/ref/rrefsqlj15446.html
--   [2] Apache Derby 10.16 Developer Guide - Views
--       https://db.apache.org/derby/docs/10.16/devguide/cdevspecial41021.html
--   [3] Apache Derby 10.16 Reference - System Tables
--       https://db.apache.org/derby/docs/10.16/ref/rrefsistabs38369.html
--   [4] Apache Derby 10.16 Tools Guide - sysinfo
--       https://db.apache.org/derby/docs/10.16/tools/ctoolsdblook.html
...
-- Derby 不支持 DROP VIEW IF EXISTS（使用 Java try-catch 处理）
-- Derby 不支持 DROP VIEW ... CASCADE（需手动删除依赖视图）

-- ============================================================
-- 5. 系统目录查询（System Catalog Queries）
-- ============================================================
