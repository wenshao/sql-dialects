...
-- Flink SQL 的核心场景是流处理
-- ============================================
CREATE VIEW windowed_orders AS
SELECT
    user_id,
...
-- ============================================
-- 替代方案：
-- 1. 使用 CREATE TABLE ... AS SELECT (CTAS) 将结果写入外部存储
-- 2. 使用 INSERT INTO ... SELECT 持续写入 sink 表
-- 3. 使用 Flink Materialized Table（1.20+，实验性功能）
