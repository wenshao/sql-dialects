...
--   [2] MySQL 8.0 Reference Manual - View Algorithms
--       https://dev.mysql.com/doc/refman/8.0/en/view-algorithms.html
--   [3] MySQL 8.0 Reference Manual - Updatable Views
--       https://dev.mysql.com/doc/refman/8.0/en/view-updatability.html
--   [4] MySQL 8.0 Reference Manual - WITH CHECK OPTION
...
-- ============================================================
-- 2. 视图算法: MERGE vs TEMPTABLE（对 SQL 引擎开发者）
-- ============================================================
...
-- ============================================================
-- 3. 可更新视图的限制（对 SQL 引擎开发者）
-- ============================================================

-- 3.1 MySQL 的可更新视图条件（所有条件都必须满足）:
--   a. 视图与基表行之间存在一对一映射
...
-- ============================================================
-- 4. 物化视图: MySQL 的缺失（对 SQL 引擎开发者）
-- ============================================================

-- MySQL 不支持原生物化视图，只能手动模拟:

-- 4.1 方案一: 表 + EVENT 定时刷新
