-- Google Cloud Spanner: 视图 (Views)
-- Spanner is Google Cloud's globally distributed relational database.
--
-- 参考资料:
...
--   [3] Spanner Documentation - STORING Index
--       https://cloud.google.com/spanner/docs/secondary-indexes#storing-columns
--   [4] Spanner Documentation - Change Streams
--       https://cloud.google.com/spanner/docs/change-streams
--   [5] Spanner Documentation - Query Syntax
