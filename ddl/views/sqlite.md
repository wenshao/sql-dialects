...
> 参考资料:
> - [SQLite Documentation - CREATE VIEW](https://www.sqlite.org/lang_createview.html)
> - [SQLite Documentation - INSTEAD OF Triggers](https://www.sqlite.org/lang_createtrigger.html)
...
## 不支持 CREATE OR REPLACE VIEW（设计分析）
