...
--
-- 参考资料:
--   [1] TDengine Documentation - SQL Manual
--       https://docs.tdengine.com/reference/sql/
--   [2] TDengine Documentation - Views (3.2.1+)
--       https://docs.tdengine.com/reference/sql/view/
--   [3] TDengine Documentation - Continuous Query
--       https://docs.tdengine.com/develop/continuous-query/
