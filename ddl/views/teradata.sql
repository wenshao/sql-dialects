...
--
-- 参考资料:
--   [1] Teradata Documentation - CREATE VIEW
--       https://docs.teradata.com/r/Enterprise_IntelliFlex_VMware/SQL-Data-Definition-Language-Syntax-and-Examples/View-Statements/CREATE-VIEW
--   [2] Teradata Documentation - Materialized Views (Join Indexes)
--       https://docs.teradata.com/r/Enterprise_IntelliFlex_VMware/SQL-Data-Definition-Language-Syntax-and-Examples/Index-Statements/CREATE-JOIN-INDEX
