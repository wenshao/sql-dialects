...
> 参考资料:
> - [Trino Documentation - CREATE VIEW](https://trino.io/docs/current/sql/create-view.html)
> - [Trino Documentation - CREATE MATERIALIZED VIEW](https://trino.io/docs/current/sql/create-materialized-view.html)
