...
--
-- 参考资料:
--   [1] Vertica Documentation - CREATE VIEW
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/SQLReferenceManual/Statements/CREATEVIEW.htm
--   [2] Vertica Documentation - Projections (Materialized Views)
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/AdministratorsGuide/Projections/Projections.htm
--   [3] Vertica Documentation - Live Aggregate Projections
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/AdministratorsGuide/Projections/LiveAggregateProjections.htm
