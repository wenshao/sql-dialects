-- Flink SQL: DELETE (Flink 1.17+, limited support)
--
-- 参考资料:
...
-- DELETE is only supported in batch mode for certain connectors
-- Streaming tables (Kafka) do NOT support DELETE

-- JDBC connector: Basic delete (batch mode)
...
-- 1. Retraction/changelog pattern
...
-- 2. Upsert with NULL value (tombstone in Kafka)
...
-- 3. JDBC sink with changelog mode
