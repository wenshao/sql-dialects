...
> 参考资料:
> - [Oracle SQL Language Reference - DELETE](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/DELETE.html)
> - [Oracle SQL Language Reference - TRUNCATE TABLE](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/TRUNCATE-TABLE.html)
...
## Flashback: 恢复误删数据（Oracle 独有杀手级特性）

### Flashback Query: 查询历史时间点的数据
