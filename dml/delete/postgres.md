...
> - [PostgreSQL Source - MVCC / Dead Tuple Cleanup](https://www.postgresql.org/docs/current/routine-vacuuming.html)
...
## RETURNING 子句: PostgreSQL 最强大的 DML 特性之一
