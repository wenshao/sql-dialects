...
> 参考资料:
> - [SQL Server T-SQL - DELETE](https://learn.microsoft.com/en-us/sql/t-sql/statements/delete-transact-sql)
> - [SQL Server T-SQL - TRUNCATE TABLE](https://learn.microsoft.com/en-us/sql/t-sql/statements/truncate-table-transact-sql)
...
## OUTPUT 子句: SQL Server 的 RETURNING（对引擎开发者）
