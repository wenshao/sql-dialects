...
DELETE u FROM users u
JOIN blacklist b ON u.email = b.email;
-- 当 users 和 blacklist 的 shardkey 不同时:
--   需要先在全分片收集 blacklist 数据
--   再路由到对应分片执行 DELETE
--   涉及分布式执行计划，性能显著下降
...
-- ============================================================
-- 9. 横向对比: TDSQL vs 单机 MySQL vs 其他分布式数据库
-- ============================================================
