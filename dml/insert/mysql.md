...
> - [MySQL 8.0 Reference Manual - LOAD DATA](https://dev.mysql.com/doc/refman/8.0/en/load-data.html)
> - [MySQL Internals - InnoDB Change Buffer](https://dev.mysql.com/doc/refman/8.0/en/innodb-change-buffer.html)
> - [MySQL 8.0 Reference Manual - Bulk Data Loading for InnoDB](https://dev.mysql.com/doc/refman/8.0/en/optimizing-innodb-bulk-data-loading.html)
...
### AUTO_INCREMENT 与批量 INSERT 的锁交互
...
### 单行 INSERT vs 多行 VALUES vs LOAD DATA
