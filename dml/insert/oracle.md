...
> - [Oracle SQL Language Reference - Multitable INSERT](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/INSERT.html)
...
## 多行插入（Oracle 独有设计: INSERT ALL）

### INSERT ALL（Oracle 9i+，其他数据库无此语法）
...
## 直接路径插入（Direct-Path INSERT，Oracle 独有优化）
