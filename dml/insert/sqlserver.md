...
> 参考资料:
> - [SQL Server T-SQL - INSERT](https://learn.microsoft.com/en-us/sql/t-sql/statements/insert-transact-sql)
> - [SQL Server T-SQL - OUTPUT Clause](https://learn.microsoft.com/en-us/sql/t-sql/queries/output-clause-transact-sql)
...
## SELECT INTO: 创建新表并插入（T-SQL 特色语法）
