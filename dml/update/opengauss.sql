...
--   [3] openGauss MOT (Memory-Optimized Table) Guide
--       https://docs.opengauss.org/zh/docs/latest/docs/Developerguide/mot.html
--   [4] openGauss Column Store Guide
--       https://docs.opengauss.org/zh/docs/latest/docs/Developerguide/column-store.html
...
-- ============================================================
-- 7. MOT (Memory-Optimized Table) 的 UPDATE 行为
-- ============================================================
...
-- ============================================================
-- 8. 列存储表（Column Store）的 UPDATE 行为
-- ============================================================
