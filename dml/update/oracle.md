...
> 参考资料:
> - [Oracle SQL Language Reference - UPDATE](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/UPDATE.html)
...
## Oracle 独有的 UPDATE 语法

### 多列子查询更新（Oracle 独有的元组赋值语法）
