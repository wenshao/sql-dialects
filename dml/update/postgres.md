...
> - [PostgreSQL Source - ExecUpdate / heapam.c](https://github.com/postgres/postgres/blob/master/src/backend/access/heap/heapam.c)
...
## FROM 子句: PostgreSQL 特有的多表 UPDATE 语法
...
## UPDATE 的 MVCC 实现: 每次 UPDATE 都是 DELETE + INSERT
