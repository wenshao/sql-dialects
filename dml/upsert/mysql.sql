...
--   [3] MySQL 8.0 Reference Manual - INSERT ... ON DUPLICATE KEY UPDATE Locking
...
-- ============================================================
-- 2. ON DUPLICATE KEY UPDATE 的锁行为和死锁风险
-- ============================================================

-- 2.1 加锁过程（比普通 INSERT 复杂得多）
...
-- 5.4 ClickHouse: ReplacingMergeTree
...
-- 5.5 Doris/StarRocks: Unique Key 模型
