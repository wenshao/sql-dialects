...
> - [PostgreSQL Documentation - MERGE (15+)](https://www.postgresql.org/docs/current/sql-merge.html)
...
### SQL Server MERGE 的 Bug 和为什么专家建议避免使用
...
### WITH (NOLOCK) 与 UPSERT 的交互（SQL Server 特有问题）
