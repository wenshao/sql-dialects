...
--   [2] Aaron Bertrand - Use Caution with SQL Server's MERGE Statement
--       https://www.mssqltips.com/sqlservertip/3074/use-caution-with-sql-servers-merge-statement/
--   [3] Microsoft - Known MERGE Issues
--       https://learn.microsoft.com/en-us/sql/t-sql/statements/merge-transact-sql#remarks
