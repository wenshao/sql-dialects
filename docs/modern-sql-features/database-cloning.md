...
| SQL Server | -- | `DBCC CLONEDATABASE`（仅 schema + stats） | -- | -- | 2014 SP2 / 2016 RTM |
...
SQL Server 在 2014 SP2 / 2016 RTM 引入 `DBCC CLONEDATABASE`，但它是一个**特殊用途**的克隆命令——不是给业务用的"零拷贝克隆"，而是给 Microsoft 工程师/DBA 用的"性能问题诊断工具"。
...
| GA 时间 | 2017 | 2022 | 2021 (DBR 9.1) | 2017 | 12c (2013) | 2014 SP2 / 2016 | -- | -- |
