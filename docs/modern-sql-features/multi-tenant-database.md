...
4. **PDB 上限**：12c R1 = 252 个 PDB / CDB；12.2 / 18c 起提升至 4096 个 PDB / CDB（需 Multitenant 选件）。
...
- **12.2 (2017)**：Application Container；non-CDB 弃用；PDB 上限提升至 4096。
- **18c / 19c (2018-2019)**：Refreshable PDB；Hot Clone 等增强。
