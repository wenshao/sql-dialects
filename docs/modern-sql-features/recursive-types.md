...
2. **REF 类型是 SQL 标准的官方解药**：SQL:1999 引入 `REF(structured-type)`，把 "结构内嵌" 转化为 "标识链接"。Oracle 8i (1999)、DB2、Informix、Teradata 沿用此模型；这是面向对象数据库时代的遗产。
...
- SQL:1999 标准: ISO/IEC 9075-2:1999, REF Type 与 Object Reference 章节
