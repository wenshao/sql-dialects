...
| ClickHouse | executable UDF (进程外 fork) | TSV/JSON | 21.11+ | 不限于 Python |
| Trino | -- | -- | -- | -- |
| Presto | -- | -- | -- | -- |
...
| BigQuery | V8 | 沙箱 | 2015+ | 是 BQ 早期主推 UDF 形态 |
| Redshift | -- | -- | -- | -- |
| DuckDB | -- | -- | -- | 通过 Wasm 间接 |
| ClickHouse | -- | -- | -- | -- |
| Trino | -- | -- | -- | -- |
...
| ClickHouse | Executable UDF | fork + stdin/stdout | 21.11+ |
...
BigQuery 自 2015 年起支持 JavaScript UDF（进程内 V8 沙箱）：
...
注：ClickHouse 社区曾讨论过 Wasm UDF 方案，但截至 2025 年仍未在主线引入。
