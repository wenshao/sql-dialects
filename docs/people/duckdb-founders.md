# DuckDB 创始人 - Mark Raasveldt & Hannes Mühleisen

> 信息来源：
> - [DuckDB 官网](https://duckdb.org/)
> - [DuckDB GitHub](https://github.com/duckdb/duckdb)
> - [GitHub: Raasveldt](https://github.com/Mytherin)
> - [GitHub: Mühleisen](https://github.com/hannes)
> - [DuckDB: an Embeddable Analytical Database (SIGMOD 2019)](https://dl.acm.org/doi/10.1145/3299869.3320212)
> - [DuckDB Labs](https://duckdblabs.com/)

---

DuckDB 是一个嵌入式分析数据库，被称为"分析领域的 SQLite"。
它由两位荷兰 CWI 研究员 Mark Raasveldt 和 Hannes Mühleisen 创建。
...
Raasveldt 和 Mühleisen 都在 CWI 的 Database Architectures 组工作，
...
Hannes Mühleisen 是 CWI 的研究员，研究兴趣包括
数据管理、数据集成和数据库系统架构。
...
Hannes Mühleisen 获得了 2025 年荷兰 ICT 研究奖（ICT Research Award），
这是对他在数据管理领域学术贡献的认可。
...
Raasveldt 和 Mühleisen 最初尝试修改 MonetDB 以更好地支持
...
2019 年，Raasveldt 和 Mühleisen 创立了 DuckDB Labs，
...
Raasveldt 和 Mühleisen 发表了多篇关于 DuckDB 的学术论文，包括：
...
- **GitHub (Raasveldt)**: [github.com/Mytherin](https://github.com/Mytherin)
- **GitHub (Mühleisen)**: [github.com/hannes](https://github.com/hannes)
- **DuckDB Labs**: [duckdblabs.com](https://duckdblabs.com/)
