...
Stonebraker 在密歇根大学获得博士学位，
1971 年加入 UC Berkeley 计算机科学系，此后在此任教超过 30 年。
后来他转到 MIT 担任教授（兼职），同时继续从事数据库研究和创业。
...
项目的商业化版本后来被 Computer Associates 收购。
...
其中 1986 年的 "The Design of POSTGRES" 是数据库领域的经典文献。
...
Vertica 被 HP 收购，StreamBase 被 TIBCO 收购，
Illustra 被 Informix 收购（Informix 后被 IBM 收购）。
