...
## ONLY_FULL_GROUP_BY: 一个重要的设计决策（对引擎开发者）
...
### ONLY_FULL_GROUP_BY 模式（5.7.5+ 默认启用）
...
### 默认截断: group_concat_max_len = 1024 字节
...
### GROUPING SETS / CUBE（SQL 标准，MySQL 不支持）
