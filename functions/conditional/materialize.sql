...
--
-- 参考资料:
--   [1] Materialize Documentation - Scalar Functions
--       https://materialize.com/docs/sql/functions/
--   [2] Materialize Documentation - Types and Casting
--       https://materialize.com/docs/sql/types/
--   [3] Materialize Documentation - SELECT Statement
...
-- count=0 时 NULLIF 返回 NULL，total/NULL = NULL（而非报错）

-- ============================================================
-- 4. GREATEST / LEAST: 多值比较
-- ============================================================
...
-- ============================================================
-- 9. 横向对比: Materialize vs PostgreSQL
-- ============================================================
