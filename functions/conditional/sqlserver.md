...
> 参考资料:
> - [SQL Server T-SQL - CASE, IIF, COALESCE](https://learn.microsoft.com/en-us/sql/t-sql/language-elements/case-transact-sql)
...
## ISNULL vs COALESCE: NULL 替换的微妙差异
...
## TRY_CAST / TRY_CONVERT: 安全类型转换（2012+）
...
## GREATEST / LEAST（2022+, SQL Server 最新添加）
...
## IS NULL 判断与 SQL Server 的 ANSI_NULLS 设置
