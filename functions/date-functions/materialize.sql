...
--
-- 参考资料:
--   [1] Materialize Documentation - Date and Time Functions
--       https://materialize.com/docs/sql/functions/numeric/
--   [2] Materialize Documentation - Types
