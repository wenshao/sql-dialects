...
> 参考资料:
> - [Oracle SQL Language Reference - Datetime Functions](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/Single-Row-Functions.html)

## 当前日期时间（注意: 所有 SELECT 需要 FROM DUAL）
