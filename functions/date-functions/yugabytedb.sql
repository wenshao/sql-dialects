-- YugabyteDB: Date Functions (YSQL, v2.x+)
--
-- 参考资料:
...
-- YugabyteDB supports all PostgreSQL date functions
...
-- Construct dates (same as PostgreSQL)
...
-- Date validation (using exception handling in PL/pgSQL)
-- No built-in date validation function; use TO_DATE with exception handling
...
-- Note: clock_timestamp() returns actual wall clock time
-- Note: Based on PostgreSQL 11.2 date function set
