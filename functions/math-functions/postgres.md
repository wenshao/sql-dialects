...
> 参考资料:
> - [PostgreSQL Documentation - Mathematical Functions](https://www.postgresql.org/docs/current/functions-math.html)
> - [PostgreSQL Source - float.c, numeric.c](https://github.com/postgres/postgres/blob/master/src/backend/utils/adt/float.c)
