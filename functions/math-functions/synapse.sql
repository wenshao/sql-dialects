...
--
-- 参考资料:
--   [1] Azure Synapse Analytics - Mathematical Functions (T-SQL)
--       https://learn.microsoft.com/en-us/sql/t-sql/functions/mathematical-functions-transact-sql
--   [2] Synapse SQL Pool - Supported T-SQL Features
--       https://learn.microsoft.com/en-us/azure/synapse-analytics/sql/develop-tsql-language-elements
