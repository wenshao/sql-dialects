...
--
-- 参考资料:
--   [1] MySQL 8.0 Reference Manual - String Functions and Operators
--       https://dev.mysql.com/doc/refman/8.0/en/string-functions.html
--   [2] MySQL 8.0 Reference Manual - Regular Expressions
--       https://dev.mysql.com/doc/refman/8.0/en/regexp.html
--   [3] MySQL 8.0 Reference Manual - PIPES_AS_CONCAT SQL Mode
...
-- ============================================================
-- 2. CONCAT 的 NULL 处理（对引擎开发者: 重要的语义差异）
-- ============================================================

-- 2.1 MySQL 的 CONCAT: 任一参数 NULL → 结果 NULL
...
-- ============================================================
-- 3. || 在 MySQL 中是逻辑 OR（最大的方言陷阱之一）
-- ============================================================

-- 3.1 MySQL 默认: || 是 OR 操作符
