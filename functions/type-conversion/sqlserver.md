...
> 参考资料:
> - [SQL Server T-SQL - CAST and CONVERT](https://learn.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql)
> - [SQL Server T-SQL - Data Type Conversion](https://learn.microsoft.com/en-us/sql/t-sql/data-types/data-type-conversion-database-engine)
...
## TRY_CAST / TRY_CONVERT: 安全转换（2012+）
