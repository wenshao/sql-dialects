-- MySQL: CTE（公共表表达式，8.0+）
--
-- 参考资料:
--   [1] MySQL 8.0 Reference Manual - WITH (CTE)
--       https://dev.mysql.com/doc/refman/8.0/en/with.html
--   [2] MySQL 8.0 Reference Manual - Recursive CTE
--       https://dev.mysql.com/doc/refman/8.0/en/with.html#common-table-expressions-recursive
--   [3] MySQL 8.0 Reference Manual - Derived Table Optimization
...
-- ============================================================
-- 3. CTE 的优化行为: 物化 vs 内联（对引擎开发者关键）
-- ============================================================

-- 3.1 MySQL 8.0 的 CTE 物化策略
