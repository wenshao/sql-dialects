...
> 参考资料:
> - [Oracle SQL Language Reference - SELECT (Subquery Factoring)](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/SELECT.html)

## 基本 CTE（子查询分解，Subquery Factoring）
...
## CONNECT BY vs 递归 CTE（Oracle 的双层次查询体系）
...
## SEARCH / CYCLE 子句（11g R2+，Oracle 独有扩展）
...
### Oracle 有双层次查询体系: CONNECT BY（传统）和递归 CTE（标准）。
