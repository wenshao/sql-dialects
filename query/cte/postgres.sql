-- PostgreSQL: CTE (Common Table Expressions, 8.4+)
--
-- 参考资料:
--   [1] PostgreSQL Documentation - WITH Queries
--       https://www.postgresql.org/docs/current/queries-with.html
--   [2] PostgreSQL Source - parse_cte.c / rewriteHandler.c
--       https://github.com/postgres/postgres/blob/master/src/backend/parser/parse_cte.c
...
-- ============================================================
-- 3. 可写 CTE (9.1+): PostgreSQL 最独特的 CTE 特性
-- ============================================================
