-- PostgreSQL: 全文搜索 (Full Text Search, 8.3+ 内置)
--
-- 参考资料:
...
--   [3] PostgreSQL Source - tsearch2 / tsvector_op.c
--       https://github.com/postgres/postgres/tree/master/src/backend/tsearch

-- ============================================================
-- 1. 核心概念: tsvector 与 tsquery
-- ============================================================
