...
--
-- 参考资料:
--   [1] PostgreSQL Documentation - Table Expressions
--       https://www.postgresql.org/docs/current/queries-table-expressions.html
--   [2] PostgreSQL Source - joinpath.c / joinrels.c
--       https://github.com/postgres/postgres/blob/master/src/backend/optimizer/path/joinpath.c
...
-- ============================================================
-- 2. LATERAL JOIN (9.3+): PostgreSQL 的相关子查询升级
-- ============================================================
