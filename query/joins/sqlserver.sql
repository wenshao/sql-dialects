-- SQL Server: JOIN（含 CROSS APPLY / OUTER APPLY）
--
-- 参考资料:
--   [1] SQL Server T-SQL - FROM clause
--       https://learn.microsoft.com/en-us/sql/t-sql/queries/from-transact-sql
--   [2] SQL Server - Using APPLY
...
-- ============================================================
-- 2. CROSS APPLY / OUTER APPLY: SQL Server 最重要的 JOIN 创新
-- ============================================================
...
-- ============================================================
-- 4. WITH (NOLOCK) 提示: SQL Server 的锁提示文化
-- ============================================================
