...
--
-- 参考资料:
--   [1] Db2 SQL Reference - SELECT
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-select
--   [2] Db2 SQL Reference - FETCH FIRST
--       https://www.ibm.com/docs/en/db2/11.5?topic=clause-fetch-first-clause
--   [3] Db2 SQL Reference - OPTIMIZE FOR
--       https://www.ibm.com/docs/en/db2/11.5?topic=clauses-optimize-clause
--   [4] Db2 Window Functions
