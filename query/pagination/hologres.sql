...
--
-- 参考资料:
--   [1] Hologres SQL - SELECT (LIMIT/OFFSET)
--       https://help.aliyun.com/zh/hologres/user-guide/select
--   [2] Hologres 最佳实践 - 数据查询优化
--       https://help.aliyun.com/zh/hologres/user-guide/query-optimization
--   [3] Hologres 兼容 PostgreSQL 说明
--       https://help.aliyun.com/zh/hologres/product-overview/compatible-with-postgresql
...
-- 注意: COUNT(*) OVER() 需要扫描全部数据，列存表可能较慢
