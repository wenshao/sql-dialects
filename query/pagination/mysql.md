...
> 参考资料:
> - [MySQL 8.0 Reference Manual - SELECT ... LIMIT](https://dev.mysql.com/doc/refman/8.0/en/select.html)
...
## LIMIT OFFSET 的深分页性能问题（对 SQL 引擎开发者）
...
## 优化方案二: Keyset Pagination（键集分页/游标分页）
