...
--
-- 参考资料:
--   [1] openGauss SQL Reference - SELECT
--       https://docs.opengauss.org/zh/docs/latest/docs/SQLReference/SELECT.html
--   [2] openGauss 开发者指南 - 游标
--       https://docs.opengauss.org/zh/docs/latest/docs/Developerguide/declaring-a-cursor.html
--   [3] GaussDB 文档中心
--       https://support.huaweicloud.com/gaussdb/index.html
--   [4] GaussDB SQL Reference
--       https://support.huaweicloud.com/intl/en-us/gaussdb/index.html
