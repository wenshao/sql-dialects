...
--
-- 参考资料:
--   [1] PolarDB MySQL 版 - SQL 参考
--       https://help.aliyun.com/zh/polardb/polardb-for-mysql/developer-reference/sql-reference
--   [2] PolarDB-X SQL 参考 - SELECT
--       https://help.aliyun.com/zh/polardb/polardb-for-xscale/developer-reference/select
--   [3] PolarDB-X 分布式查询优化
--       https://help.aliyun.com/zh/polardb/polardb-for-xscale/developer-reference/optimization
...
LIMIT 10;
-- PolarDB-X 支持 MySQL 8.0 的行构造器比较语法
