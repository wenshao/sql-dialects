-- Flink SQL: PIVOT / UNPIVOT
--
-- 参考资料:
--   [1] Apache Flink Documentation - Queries
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/overview/
--   [2] Apache Flink Documentation - Aggregate Functions
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/functions/systemfunctions/#aggregate-functions
