...
--   [2] PostgreSQL Documentation - FILTER Clause
--       https://www.postgresql.org/docs/current/sql-expressions.html#SYNTAX-AGGREGATES

-- ============================================================
-- 1. PIVOT: CASE WHEN + GROUP BY（传统方式）
-- ============================================================
...
-- ============================================================
-- 2. PIVOT: FILTER 子句 (9.4+, PostgreSQL 优势)
-- ============================================================
...
-- ============================================================
-- 4. UNPIVOT: LATERAL + VALUES (9.3+, 最佳方式)
-- ============================================================
...
--
-- 2. FILTER 子句（PIVOT 最简洁方式）:
--   PostgreSQL: 独有（SQL 标准但其他数据库不实现）
--
-- 3. LATERAL + VALUES（UNPIVOT 最优雅方式）:
--   PostgreSQL: 9.3+
