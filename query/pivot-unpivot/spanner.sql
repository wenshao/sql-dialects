-- Google Cloud Spanner: PIVOT / UNPIVOT（原生支持）
--
-- 参考资料:
--   [1] Spanner Documentation - PIVOT
--       https://cloud.google.com/spanner/docs/reference/standard-sql/query-syntax#pivot_operator
--   [2] Spanner Documentation - UNPIVOT
--       https://cloud.google.com/spanner/docs/reference/standard-sql/query-syntax#unpivot_operator
