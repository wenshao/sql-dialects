...
--
-- 参考资料:
--   [1] TiDB Documentation - SELECT
--       https://docs.pingcap.com/tidb/stable/sql-statement-select
--   [2] TiDB Documentation - Control Flow Functions
--       https://docs.pingcap.com/tidb/stable/control-flow-functions
--   [3] TiDB Documentation - Aggregate Functions
--       https://docs.pingcap.com/tidb/stable/aggregate-group-by-functions
