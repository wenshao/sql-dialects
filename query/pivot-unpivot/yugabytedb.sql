-- YugabyteDB: PIVOT / UNPIVOT
--
-- 参考资料:
--   [1] YugabyteDB Documentation - SELECT
--       https://docs.yugabyte.com/preview/api/ysql/the-sql-language/statements/dml_select/
--   [2] YugabyteDB Documentation - Aggregate Functions
--       https://docs.yugabyte.com/preview/api/ysql/exprs/aggregate_functions/
