...
--
-- 参考资料:
--   [1] Vertica Documentation - UNION, INTERSECT, EXCEPT/MINUS
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/SQLReferenceManual/Statements/SELECT/UNIONClause.htm
