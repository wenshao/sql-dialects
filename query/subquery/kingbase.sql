...
--
-- 参考资料:
--   [1] KingbaseES SQL Reference - Subqueries
--       https://help.kingbase.com.cn/v8/index.html
--   [2] KingbaseES Server Programming Guide
--       https://help.kingbase.com.cn/v8/develop-guide/index.html
--   [3] PostgreSQL Documentation - Subquery Expressions
...
-- ============================================================
-- 9. 子查询优化: 提升 (Subquery Flattening)
-- ============================================================
