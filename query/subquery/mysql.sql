...
--   [2] MySQL 8.0 Reference Manual - Subquery Optimization
--       https://dev.mysql.com/doc/refman/8.0/en/subquery-optimization.html
--   [3] MySQL 8.0 Reference Manual - Derived Tables
--       https://dev.mysql.com/doc/refman/8.0/en/derived-tables.html
--   [4] MySQL 8.0 Reference Manual - Optimizing Subqueries with Semijoin
...
-- ============================================================
-- 2. MySQL 5.x 子查询的性能噩梦（历史教训）
-- ============================================================

-- 2.1 5.5 及之前的 IN 子查询问题
