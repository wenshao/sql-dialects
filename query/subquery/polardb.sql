...
--
-- 参考资料:
--   [1] PolarDB-X SQL Reference - Subqueries
--       https://help.aliyun.com/zh/polardb/polardb-for-xscale/sql-reference/
--   [2] PolarDB MySQL Documentation - SQL Syntax
--       https://help.aliyun.com/zh/polardb/polardb-for-mysql/
--   [3] PolarDB-X Optimizer Architecture
--       https://help.aliyun.com/zh/polardb/polardb-for-xscale/optimizer/
...
-- ANY 和 SOME 是同义词（MySQL/PolarDB 语法）
...
-- 关注: 是否出现 "PUSHDOWN" 或 "BROADCAST" 算子
...
-- ============================================================
-- 8. 子查询优化: MySQL 8.0 优化器 + PolarDB-X 增强
-- ============================================================
