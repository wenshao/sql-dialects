-- PostgreSQL: 子查询 (Subqueries)
--
-- 参考资料:
--   [1] PostgreSQL Documentation - Subquery Expressions
--       https://www.postgresql.org/docs/current/functions-subquery.html
--   [2] PostgreSQL Source - subselect.c (子查询优化)
--       https://github.com/postgres/postgres/blob/master/src/backend/optimizer/plan/subselect.c
