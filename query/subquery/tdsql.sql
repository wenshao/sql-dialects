...
--
-- 参考资料:
--   [1] TDSQL-C MySQL Documentation - SQL Statements
--       https://cloud.tencent.com/document/product/1003
--   [2] TDSQL MySQL Documentation - Distributed Queries
--       https://cloud.tencent.com/document/product/557
--   [3] MySQL 8.0 Reference - Subqueries
...
-- ANY 和 SOME 是同义词（MySQL/TDSQL 语法）
...
-- 关注: select_type 列是否出现 SUBQUERY / DEPENDENT SUBQUERY
-- 理想: 出现 MATERIALIZED 或 SEMI JOIN（说明已优化）

-- ============================================================
-- 8. 横向对比: TDSQL vs 其他数据库
-- ============================================================
