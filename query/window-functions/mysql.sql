...
--   [3] MySQL 8.0 Reference Manual - Window Function Frame Specification
...
-- 3.3 NTH_VALUE / LAST_VALUE 的默认帧陷阱
...
-- 3.4 LAG/LEAD/ROW_NUMBER/RANK 不受帧影响
-- 这些函数忽略帧子句（按整个分区计算），所以没有默认帧陷阱

-- ============================================================
-- 4. 命名窗口 WINDOW 子句（减少重复和错误）
-- ============================================================
...
-- 6.1 QUALIFY 子句（Snowflake/Teradata/BigQuery/DuckDB）
