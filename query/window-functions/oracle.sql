-- Oracle: 窗口函数 / 分析函数（Oracle 8i 首创，1999年）
--
-- 参考资料:
...
-- 5.1 RATIO_TO_REPORT: 计算占比（Oracle 独有）
SELECT username, age,
    RATIO_TO_REPORT(age) OVER () AS age_ratio
FROM users;
-- 其他数据库需要: age * 1.0 / SUM(age) OVER ()

-- 5.2 KEEP (DENSE_RANK FIRST/LAST): 组内取特定排名的聚合值
SELECT city,
...
-- ============================================================
-- 6. 帧子句（Window Frame，Oracle 的实现最完善）
-- ============================================================
...
-- ============================================================
-- 9. MODEL 子句（Oracle 10g+ 独有，电子表格式计算）
-- ============================================================
