-- Greenplum: 日期序列生成与间隙填充 (Date Series Fill)
--
-- 参考资料:
--   [1] Greenplum Documentation - SQL Reference
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-function-summary.html
--   [2] Greenplum Documentation - Window Functions
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-sql_commands-SELECT.html
...
-- 注意：Greenplum 兼容 PostgreSQL，支持 generate_series
