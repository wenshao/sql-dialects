-- Materialize: 日期序列生成与间隙填充 (Date Series Fill)
--
-- 参考资料:
--   [1] Materialize Documentation - SQL Reference
--       https://materialize.com/docs/sql/functions/generate_series/
--   [2] Materialize Documentation - Window Functions
...
-- 注意：Materialize 兼容 PostgreSQL，支持 generate_series
