...
> 参考资料:
> - [OceanBase Documentation - SQL Reference](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001576792)
> - [OceanBase Documentation - Functions](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001577057)
...
## 用最近已知值填充（Oracle 模式支持 IGNORE NULLS）
