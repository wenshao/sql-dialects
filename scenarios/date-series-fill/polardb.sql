-- PolarDB: 日期序列生成与间隙填充 (Date Series Fill)
--
-- 参考资料:
--   [1] PolarDB Documentation - CTE
--       https://www.alibabacloud.com/help/en/polardb/latest/with
--   [2] PolarDB Documentation - Date Functions
--       https://www.alibabacloud.com/help/en/polardb/latest/date-and-time-functions
