...
--
-- 参考资料:
--   [1] TimescaleDB Documentation - time_bucket_gapfill
--       https://docs.timescale.com/api/latest/hyperfunctions/gapfilling/time_bucket_gapfill/
--   [2] TimescaleDB Documentation - locf / interpolate
--       https://docs.timescale.com/api/latest/hyperfunctions/gapfilling/locf/
--   [3] PostgreSQL Documentation - generate_series
...
-- ============================================================
-- 1. generate_series（PostgreSQL 标准方法）
-- ============================================================
...
-- ============================================================
-- 2. time_bucket_gapfill（TimescaleDB 特有）
-- ============================================================
...
-- ============================================================
-- 3. locf —— 用最近已知值填充（Last Observation Carried Forward）
-- ============================================================
...
-- ============================================================
-- 5. LEFT JOIN 标准方法（PostgreSQL 兼容）
-- ============================================================
