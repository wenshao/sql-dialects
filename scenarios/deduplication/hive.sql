...
-- ============================================================
-- 假设表结构:
--   users(user_id INT, email STRING, username STRING, created_at STRING)
...
-- Hive 不支持 DELETE/UPDATE（除非使用 ACID 表）
-- 推荐 CTAS 方式重建表
-- INSERT OVERWRITE TABLE users SELECT ... 替代 DELETE
