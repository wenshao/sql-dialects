...
> 参考资料:
> - [SQL Server - DELETE with CTE](https://learn.microsoft.com/en-us/sql/t-sql/statements/delete-transact-sql)
...
## CTE + DELETE: SQL Server 最优雅的去重方式
...
## APPROX_COUNT_DISTINCT（2019+, 近似去重计数）
