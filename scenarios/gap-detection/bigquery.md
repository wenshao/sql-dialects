# BigQuery: 间隙检测与岛屿问题 (Gap Detection & Islands)

> 参考资料:
> - [1] BigQuery Documentation - Analytic Functions
>   https://cloud.google.com/bigquery/docs/reference/standard-sql/analytic-function-concepts
> - [2] BigQuery Documentation - GENERATE_ARRAY / GENERATE_DATE_ARRAY
...
SELECT * FROM UNNEST([
    STRUCT(1 AS id, 'a' AS info), (2,'b'), (3,'c'),
    (5,'e'), (6,'f'), (10,'j'), (11,'k'), (12,'l'), (15,'o')
]);
...
## 5. 使用 GENERATE_ARRAY / GENERATE_DATE_ARRAY（BigQuery 特有）
...
注意：BigQuery 使用 GENERATE_ARRAY 和 GENERATE_DATE_ARRAY 替代 generate_series
注意：BigQuery 不支持递归 CTE
