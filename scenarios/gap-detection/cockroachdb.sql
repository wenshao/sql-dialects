-- CockroachDB: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
--   [1] CockroachDB Documentation - Window Functions
--       https://www.cockroachlabs.com/docs/stable/window-functions
--   [2] CockroachDB Documentation - generate_series
--       https://www.cockroachlabs.com/docs/stable/functions-and-operators#generate-series
...
-- ============================================================
-- 5. 使用 generate_series（CockroachDB 兼容 PostgreSQL）
-- ============================================================
