...
--
-- 参考资料:
--   [1] DamengDB Documentation - 分析函数
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-dataquery.html
--   [2] DamengDB Documentation - 层次查询
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-dataquery.html#层次查询
...
-- ============================================================
-- 5. 使用 CONNECT BY 生成序列（DamengDB 兼容 Oracle）
-- ============================================================
