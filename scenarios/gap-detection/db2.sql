...
--
-- 参考资料:
--   [1] DB2 Documentation - OLAP Specifications
--       https://www.ibm.com/docs/en/db2/11.5?topic=functions-olap-specification
--   [2] DB2 Documentation - Recursive Common Table Expressions
...
-- ============================================================
-- 5. 递归 CTE 生成序列（DB2 早期版本就支持递归 CTE）
-- ============================================================
