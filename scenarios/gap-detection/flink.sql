-- Flink SQL: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
--   [1] Flink Documentation - Window Functions
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/window-agg/
--   [2] Flink Documentation - Over Aggregation
...
-- ============================================================
-- 1. 使用 LAG/LEAD 查找数值间隙（Flink 批模式）
-- ============================================================
