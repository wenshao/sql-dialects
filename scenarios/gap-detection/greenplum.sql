-- Greenplum: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
--   [1] Greenplum Documentation - Window Functions
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-function-summary.html
--   [2] Greenplum Documentation - generate_series
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-function-summary.html
...
-- 注意：Greenplum 基于 PostgreSQL，兼容 generate_series
-- 注意：Greenplum 的 MPP 架构下，窗口函数会触发数据重分布
-- 注意：大数据集上推荐使用分布键优化窗口函数性能
-- 注意：Greenplum 7 兼容 PostgreSQL 12+
