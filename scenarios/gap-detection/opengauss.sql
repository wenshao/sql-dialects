-- openGauss: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
...
--   [2] openGauss Documentation - generate_series
--       https://docs.opengauss.org/en/docs/latest/docs/SQLReference/functions-and-operators.html
...
-- 注意：openGauss 基于 PostgreSQL，兼容 generate_series 语法
-- 注意：openGauss 从早期版本开始支持窗口函数
-- 注意：openGauss 的优化器对窗口函数有专门优化
