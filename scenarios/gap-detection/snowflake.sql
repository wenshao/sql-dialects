...
-- ============================================================
-- 5. 使用 GENERATOR / TABLE(GENERATOR(...)) 生成序列
-- ============================================================

-- 使用 GENERATOR + ROW_NUMBER 生成数值序列
WITH params AS (
...
-- 注意：Snowflake 使用 GENERATOR 替代 generate_series
-- 注意：QUALIFY 是 Snowflake 支持的过滤窗口函数结果的子句
-- 注意：DATEDIFF('DAY', start, end) 计算日期差值
