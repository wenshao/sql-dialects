...
--   [2] Spark SQL Documentation - sequence function
...
-- ============================================================
-- 5. 使用 sequence + explode 生成序列（Spark 2.4+）
-- ============================================================
...
-- 注意：Spark SQL 的 sequence() 函数从 2.4 版本开始支持
-- 注意：sequence 生成数组，需要用 explode 展开为行
-- 注意：Spark SQL 不支持递归 CTE（Spark 3.x 部分版本实验性支持）
