-- TDSQL (腾讯云): 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
--   [1] TDSQL Documentation - Window Functions
--       https://cloud.tencent.com/document/product/557/20042
--   [2] TDSQL Documentation - SQL Reference
...
-- 注意：TDSQL 兼容 MySQL 语法
-- 注意：TDSQL 支持窗口函数和递归 CTE
-- 注意：TDSQL 分布式版本窗口函数可能涉及跨分片操作
-- 注意：TDSQL 使用 DATEDIFF 计算日期差值
