-- TiDB: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
...
-- 注意：TiDB 兼容 MySQL 语法，窗口函数从 3.0 版本开始支持
-- 注意：递归 CTE 需要 TiDB 5.1+
-- 注意：TiDB 分布式环境下窗口函数可能触发全表排序
