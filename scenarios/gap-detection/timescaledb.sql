-- TimescaleDB: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
--   [1] TimescaleDB Documentation - Hyperfunctions
...
-- 注意：TimescaleDB 是 PostgreSQL 扩展，完全兼容 PostgreSQL 语法
-- 注意：TimescaleDB 的 time_bucket_gapfill 可自动填充时间间隙
-- 注意：对于时序数据的间隙检测，推荐使用 time_bucket_gapfill
-- 注意：generate_series 和窗口函数完全可用
