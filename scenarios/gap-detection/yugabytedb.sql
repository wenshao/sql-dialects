-- YugabyteDB: 间隙检测与岛屿问题 (Gap Detection & Islands)
--
-- 参考资料:
--   [1] YugabyteDB Documentation - Window Functions
--       https://docs.yugabyte.com/preview/api/ysql/exprs/window_functions/
--   [2] YugabyteDB Documentation - generate_series
--       https://docs.yugabyte.com/preview/api/ysql/the-sql-language/statements/
...
-- 注意：YugabyteDB 兼容 PostgreSQL 语法，支持 generate_series
-- 注意：YugabyteDB 从 2.0 开始支持窗口函数
-- 注意：分布式环境下窗口函数可能涉及跨节点数据传输
-- 注意：YugabyteDB 的 YSQL API 与 PostgreSQL 高度兼容
