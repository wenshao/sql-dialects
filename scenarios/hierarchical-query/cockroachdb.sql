-- CockroachDB: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] CockroachDB Documentation - WITH RECURSIVE
--       https://www.cockroachlabs.com/docs/stable/common-table-expressions#recursive-ctes
--   [2] CockroachDB Documentation - SQL Reference
...
-- 注意：CockroachDB 兼容 PostgreSQL 语法，支持递归 CTE
-- 注意：CockroachDB 分布式环境下递归 CTE 在单个节点上执行
-- 注意：CockroachDB 不支持 CONNECT BY
-- 注意：大规模递归查询可能影响性能
