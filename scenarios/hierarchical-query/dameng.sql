-- DamengDB (达梦): 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] DamengDB Documentation - 层次查询
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-dataquery.html
--   [2] DamengDB Documentation - 递归 CTE
--       https://eco.dameng.com/document/dm/zh-cn/sql-dev/dmpl-sql-dataquery.html
...
-- 注意：DamengDB 兼容 Oracle，支持 CONNECT BY
-- 注意：DamengDB 支持递归 CTE
-- 注意：DamengDB 支持 SYS_CONNECT_BY_PATH
-- 注意：DamengDB 支持 CONNECT_BY_ROOT 和 CONNECT_BY_ISLEAF
