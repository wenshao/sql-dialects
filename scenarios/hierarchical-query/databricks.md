...
> 参考资料:
> - [Databricks SQL Reference - Common Table Expressions](https://docs.databricks.com/en/sql/language-manual/sql-ref-syntax-qry-select-cte.html)
> - [Databricks SQL Reference - SQL Reference](https://docs.databricks.com/en/sql/language-manual/index.html)
