-- IBM DB2: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] DB2 Documentation - Recursive Common Table Expressions
--       https://www.ibm.com/docs/en/db2/11.5?topic=queries-recursive-common-table-expressions
--   [2] DB2 Documentation - SQL Reference
...
-- 注意：DB2 不支持 CONNECT BY
-- 注意：DB2 递归 CTE 使用 UNION ALL（不支持 UNION）
-- 注意：DB2 使用 || 连接字符串
