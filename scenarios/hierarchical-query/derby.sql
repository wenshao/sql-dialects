-- Apache Derby: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] Apache Derby Documentation - WITH clause
--       https://db.apache.org/derby/docs/10.16/ref/rrefsqljwith.html
--   [2] Apache Derby Documentation - SQL Reference
...
-- 注意：递归 CTE 从 Derby 10.12 开始支持
-- 注意：Derby 不支持 CONNECT BY
-- 注意：Derby 不支持 REPEAT 函数
-- 注意：Derby 的窗口函数支持有限
