...
> 参考资料:
> - [DuckDB Documentation - WITH RECURSIVE](https://duckdb.org/docs/sql/query_syntax/with.html)
> - [DuckDB Documentation - Recursive CTEs](https://duckdb.org/docs/sql/query_syntax/with.html#recursive-ctes)
...
**注意:** DuckDB 完整支持递归 CTE
**注意:** DuckDB 不支持 CONNECT BY
**注意:** DuckDB 的列式引擎对递归查询有特定优化
**注意:** DuckDB 支持 UNION ALL 和 UNION 两种递归模式
