-- Firebird: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] Firebird Documentation - Common Table Expressions
...
--   [2] Firebird Documentation - Recursive CTEs
...
-- 注意：Firebird 不支持 CONNECT BY
-- 注意：Firebird 使用 || 连接字符串
-- 注意：Firebird 限制递归深度为 1024
