# Greenplum: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)

> 参考资料:
> - [Greenplum Documentation - WITH clause](https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-sql_commands-SELECT.html)
> - [Greenplum Documentation - SQL Reference](https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-sql_commands-SELECT.html)
...
注意：Greenplum 7+ 支持递归 CTE（基于 PostgreSQL 12+）
注意：Greenplum 6 不支持递归 CTE
注意：Greenplum 不支持 CONNECT BY
注意：MPP 架构下递归 CTE 在 master 节点执行
