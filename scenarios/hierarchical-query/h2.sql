-- H2 Database: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] H2 Documentation - WITH RECURSIVE
--       https://h2database.com/html/grammar.html#with
--   [2] H2 Documentation - SQL Reference
