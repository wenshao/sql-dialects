-- Hologres: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] Hologres Documentation - SQL Reference
--       https://www.alibabacloud.com/help/en/hologres/user-guide/overview
--   [2] Hologres Documentation - CTE
--       https://www.alibabacloud.com/help/en/hologres/user-guide/with-query
...
-- 注意：Hologres 对递归 CTE 支持有限
-- 注意：推荐使用物化路径模型
-- 注意：Hologres 不支持 CONNECT BY
