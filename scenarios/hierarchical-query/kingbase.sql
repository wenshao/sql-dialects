-- KingbaseES (人大金仓): 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] KingbaseES Documentation - Recursive CTE
--       https://help.kingbase.com.cn/v8/development/sql-plsql/sql/
--   [2] KingbaseES Documentation - CONNECT BY
--       https://help.kingbase.com.cn/v8/development/sql-plsql/sql/
...
-- 注意：KingbaseES 支持递归 CTE
-- 注意：KingbaseES 支持 CONNECT BY（Oracle 兼容模式）
-- 注意：KingbaseES V8R6+ 完整支持层次查询
