# MariaDB: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)

> 参考资料:
> - [MariaDB Documentation - Recursive CTEs](https://mariadb.com/kb/en/recursive-common-table-expressions-overview/)
> - [MariaDB Documentation - WITH clause](https://mariadb.com/kb/en/with/)
...
注意：MariaDB 10.5+ 支持 CYCLE 子句
注意：默认递归深度 1000（max_recursive_iterations）
注意：MariaDB 不支持 CONNECT BY
