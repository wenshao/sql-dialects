-- Materialize: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] Materialize Documentation - WITH RECURSIVE
--       https://materialize.com/docs/sql/select/#recursive-ctes
--   [2] Materialize Documentation - SQL Reference
...
-- 注意：Materialize 支持递归 CTE
-- 注意：Materialize 不支持 CONNECT BY
-- 注意：递归 CTE 的结果可以物化为增量维护的视图
-- 注意：Materialize 兼容 PostgreSQL 语法
