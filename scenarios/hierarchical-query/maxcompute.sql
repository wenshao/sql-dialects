-- MaxCompute (ODPS): 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] MaxCompute (ODPS) Documentation - SQL Reference
--       https://www.alibabacloud.com/help/en/maxcompute/user-guide/overview-of-sql-statements

-- ============================================================
-- MaxCompute (ODPS) 不支持递归 CTE，使用替代方案
-- ============================================================
