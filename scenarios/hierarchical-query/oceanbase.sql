-- OceanBase: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] OceanBase Documentation - Recursive CTE
--       https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001577057
--   [2] OceanBase Documentation - CONNECT BY
--       https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001576792
...
-- 注意：OceanBase 支持递归 CTE（MySQL 和 Oracle 模式）
-- 注意：OceanBase Oracle 模式支持 CONNECT BY
-- 注意：Oracle 模式支持 SYS_CONNECT_BY_PATH、CONNECT_BY_ROOT
-- 注意：MySQL 模式语法与 MySQL 8.0 兼容
