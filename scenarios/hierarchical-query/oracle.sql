-- Oracle: 层次查询与树形结构 (Hierarchical Query)
--
-- 参考资料:
--   [1] Oracle SQL Language Reference - Hierarchical Queries (CONNECT BY)
...
-- ============================================================
-- 1. CONNECT BY（Oracle 独有的经典层次查询，所有版本）
-- ============================================================
