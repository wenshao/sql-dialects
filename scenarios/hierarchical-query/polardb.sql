-- PolarDB: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] PolarDB Documentation - SQL Reference
--       https://www.alibabacloud.com/help/en/polardb/latest/sql-reference
--   [2] PolarDB Documentation - CTE
--       https://www.alibabacloud.com/help/en/polardb/latest/with
...
-- 注意：PolarDB 支持递归 CTE
-- 注意：PolarDB MySQL 模式兼容 MySQL 8.0
-- 注意：PolarDB PostgreSQL 模式兼容 PostgreSQL
-- 注意：PolarDB 不支持 CONNECT BY
