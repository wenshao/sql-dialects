# Amazon Redshift: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)

> 参考资料:
> - [Redshift Documentation - WITH clause](https://docs.aws.amazon.com/redshift/latest/dg/r_WITH_clause.html)
> - [Redshift Documentation - SQL Reference](https://docs.aws.amazon.com/redshift/latest/dg/cm_chap_SQLCommandRef.html)
...
注意：Redshift 不支持递归 CTE（截至 2024 年）
注意：Redshift 不支持 CONNECT BY
注意：需使用多层自连接或应用层实现层次查询
注意：物化路径是 Redshift 上最推荐的层次结构方案
