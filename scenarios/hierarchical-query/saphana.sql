-- SAP HANA: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] SAP HANA Documentation - Hierarchical Queries
--       https://help.sap.com/docs/SAP_HANA_PLATFORM/4fe29514fd584807ac9f2a04f6754767
--   [2] SAP HANA Documentation - HIERARCHY function
--       https://help.sap.com/docs/SAP_HANA_PLATFORM/4fe29514fd584807ac9f2a04f6754767/51129989b88c4e4ea9ee0dc54b0e0bb5.html
...
-- 注意：SAP HANA 支持递归 CTE
-- 注意：SAP HANA 支持 HIERARCHY 函数（原生层次查询）
-- 注意：SAP HANA 的 HIERARCHY 函数比递归 CTE 更高效
-- 注意：SAP HANA 不支持 CONNECT BY 语法
