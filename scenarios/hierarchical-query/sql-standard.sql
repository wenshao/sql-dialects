-- SQL Standard: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] ISO/IEC 9075 SQL:1999 - WITH RECURSIVE
--       https://www.iso.org/standard/26197.html
--   [2] ISO/IEC 9075 SQL:2003 - Recursive Query
--       https://www.iso.org/standard/34133.html
...
FROM org_tree ORDER BY ordercol;
...
-- 注意：SEARCH DEPTH/BREADTH FIRST 是 SQL:1999 标准
-- 注意：CYCLE 子句是 SQL:1999 标准
-- 注意：CONNECT BY 不是 SQL 标准（Oracle 专有语法）
