-- TDSQL (腾讯云): 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] TDSQL Documentation - SQL Reference
--       https://cloud.tencent.com/document/product/557/19764
--   [2] TDSQL Documentation - CTE
--       https://cloud.tencent.com/document/product/557/20042
...
-- 注意：TDSQL 兼容 MySQL 语法，支持递归 CTE
-- 注意：TDSQL 不支持 CONNECT BY
-- 注意：分布式版本递归 CTE 在协调节点执行
-- 注意：TDSQL 使用 CONCAT 连接字符串
