-- Teradata: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] Teradata Documentation - Recursive Queries
--       https://docs.teradata.com/r/SQL-Data-Manipulation-Language/Recursive-Queries
--   [2] Teradata Documentation - SQL Reference
--       https://docs.teradata.com/r/SQL-Functions-Expressions-and-Predicates
...
-- 注意：Teradata 支持递归 CTE
-- 注意：Teradata 不支持 CONNECT BY
-- 注意：Teradata 的 QUALIFY 子句可用于过滤递归结果
-- 注意：Teradata 限制递归深度以防止无限循环
