# Vertica: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)

> 参考资料:
> - [Vertica Documentation - Recursive Queries](https://www.vertica.com/docs/latest/HTML/Content/Authoring/SQLReferenceManual/Statements/SELECT/WITHClause.htm)
> - [Vertica Documentation - SQL Reference](https://www.vertica.com/docs/latest/HTML/Content/Authoring/SQLReferenceManual/SQLReferenceManual.htm)
...
注意：Vertica 支持递归 CTE
注意：Vertica 不支持 CONNECT BY
注意：列式存储对递归查询的性能影响需要注意
注意：Vertica 推荐使用物化路径模型
