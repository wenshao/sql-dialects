...
--
-- 参考资料:
--   [1] Vertica Documentation - Recursive Queries
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/SQLReferenceManual/Statements/SELECT/WITHClause.htm
--   [2] Vertica Documentation - SQL Reference
