-- YugabyteDB: 层次查询与树形结构 (Hierarchical Query & Tree Traversal)
--
-- 参考资料:
--   [1] YugabyteDB Documentation - Recursive CTEs
--       https://docs.yugabyte.com/preview/api/ysql/the-sql-language/statements/
--   [2] YugabyteDB Documentation - WITH clause
--       https://docs.yugabyte.com/preview/api/ysql/the-sql-language/statements/perf_with/
...
-- 注意：YugabyteDB 兼容 PostgreSQL，完整支持递归 CTE
-- 注意：YugabyteDB 不支持 CONNECT BY
-- 注意：分布式环境下递归 CTE 性能需要关注
-- 注意：YugabyteDB 支持 ltree 扩展
