...
--
-- 参考资料:
--   [1] Databricks SQL Reference - from_json
--       https://docs.databricks.com/sql/language-manual/functions/from_json.html
--   [2] Databricks SQL Reference - explode / inline
--       https://docs.databricks.com/sql/language-manual/functions/explode.html
--   [3] Databricks SQL Reference - schema_of_json
--       https://docs.databricks.com/sql/language-manual/functions/schema_of_json.html
