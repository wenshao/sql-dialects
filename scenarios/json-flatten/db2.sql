...
--
-- 参考资料:
--   [1] IBM DB2 Documentation - JSON Functions
--       https://www.ibm.com/docs/en/db2/11.5?topic=functions-json-value
--   [2] IBM DB2 Documentation - JSON_TABLE
--       https://www.ibm.com/docs/en/db2/11.5?topic=functions-json-table
...
-- ============================================================
-- 4. SYSTOOLS.BSON2JSON / JSON2BSON（旧版 DB2 的 NoSQL 兼容层）
-- ============================================================
