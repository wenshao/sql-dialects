-- MySQL: JSON 展平为关系行 (JSON Flatten)
--
-- 参考资料:
--   [1] MySQL 8.0 Reference Manual - JSON Functions
--       https://dev.mysql.com/doc/refman/8.0/en/json-functions.html
--   [2] MySQL 8.0 Reference Manual - JSON_TABLE
...
-- ============================================================
-- 2. JSON_TABLE 展开数组为多行（推荐, MySQL 8.0.4+）
-- ============================================================
SELECT o.id,
...
-- ============================================================
-- 5. JSON_ARRAYAGG / JSON_OBJECTAGG（反向：行转 JSON）
-- ============================================================
