...
> 参考资料:
> - [Oracle SQL Language Reference - JSON_TABLE](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/JSON_TABLE.html)
...
## JSON_TABLE: 展开数组为多行（12c+，Oracle 最早且最完整的实现）
