...
> 参考资料:
> - [Cloud Spanner - JSON Data Type](https://cloud.google.com/spanner/docs/reference/standard-sql/data-types#json_type)
> - [Cloud Spanner - JSON Functions](https://cloud.google.com/spanner/docs/reference/standard-sql/json_functions)
> - [Cloud Spanner - Query Syntax (UNNEST)](https://cloud.google.com/spanner/docs/reference/standard-sql/query-syntax)
