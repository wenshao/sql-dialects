...
> 参考资料:
> - [SQLite Documentation - JSON1 Extension](https://www.sqlite.org/json1.html)
> - [SQLite Documentation - json_each / json_tree](https://www.sqlite.org/json1.html#jeach)
...
## json_group_array / json_group_object（反向：行转 JSON）
