...
--   [2] PostgreSQL Documentation - JSON Functions（TimescaleDB 完全兼容）
--       https://www.postgresql.org/docs/current/functions-json.html
--   [3] TimescaleDB Hypertable 概念
...
-- ============================================================
-- 5. 时间范围查询 + JSON 展平（TimescaleDB 特有优势）
-- ============================================================
...
-- ============================================================
-- 7. 连续聚合 + JSON 提取（TimescaleDB 高级用法）
-- ============================================================
