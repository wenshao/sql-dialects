...
--
-- 参考资料:
--   [1] Vertica Documentation - Flex Tables and JSON
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/FlexTables/FlexTables.htm
--   [2] Vertica Documentation - JSON Functions
--       https://www.vertica.com/docs/latest/HTML/Content/Authoring/SQLReferenceManual/Functions/JSON/JSONFunctions.htm
