...
--
-- 参考资料:
--   [1] YugabyteDB Documentation - JSON Data Type (YSQL)
--       https://docs.yugabyte.com/preview/api/ysql/datatypes/type_json/
--   [2] YugabyteDB Documentation - JSON Functions
--       https://docs.yugabyte.com/preview/api/ysql/functions-operators/jsonb/
--   [3] PostgreSQL Documentation - JSON Functions（YugabyteDB 兼容）
