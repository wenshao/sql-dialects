-- MySQL: 迁移速查表 (Migration Cheatsheet)
--
-- 参考资料:
--   [1] MySQL 8.0 Reference Manual - SQL Differences
--       https://dev.mysql.com/doc/refman/8.0/en/differences-from-ansi.html
--   [2] MySQL 8.0 - Migrating to MySQL
--       https://dev.mysql.com/doc/refman/8.0/en/migration-guide.html
