...
--
-- 参考资料:
--   [1] IBM Db2 Documentation - OLAP Functions
--       https://www.ibm.com/docs/en/db2/11.5?topic=functions-olap-window
--   [2] IBM Db2 Documentation - FETCH FIRST
--       https://www.ibm.com/docs/en/db2/11.5?topic=clause-fetch-first
