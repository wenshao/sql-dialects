# PostgreSQL: 排名与 Top-N

> 参考资料:
> - [PostgreSQL Documentation - LIMIT / FETCH](https://www.postgresql.org/docs/current/queries-limit.html)
> - [PostgreSQL Documentation - DISTINCT ON](https://www.postgresql.org/docs/current/sql-select.html#SQL-DISTINCT)
