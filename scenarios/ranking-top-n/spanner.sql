-- Google Cloud Spanner: Top-N 查询（排名与分组取前 N 条）
--
-- 参考资料:
...
--   [2] Spanner Documentation - LIMIT
--       https://cloud.google.com/spanner/docs/reference/standard-sql/query-syntax#limit_and_offset_clause
