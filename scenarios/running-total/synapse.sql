-- Azure Synapse Analytics: 累计/滚动合计（Running Total）
--
-- 参考资料:
--   [1] Synapse Documentation - Window Functions
--       https://learn.microsoft.com/en-us/azure/synapse-analytics/sql/query-ranking-functions
...
-- DISTRIBUTION = HASH(account_id) 使分组累计本地执行
-- Synapse 兼容 T-SQL 语法
-- 必须显式指定 ROWS 帧（RANGE 默认性能差）
