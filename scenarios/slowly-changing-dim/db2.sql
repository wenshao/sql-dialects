...
--
-- 参考资料:
--   [1] IBM DB2 Documentation - MERGE
--       https://www.ibm.com/docs/en/db2/11.5?topic=statements-merge
--   [2] IBM DB2 Documentation - Temporal Tables
--       https://www.ibm.com/docs/en/db2/11.5?topic=tables-temporal
