...
> 参考资料:
> - [DuckDB Documentation - INSERT ... ON CONFLICT](https://duckdb.org/docs/sql/statements/insert#on-conflict-clause)
> - [DuckDB Documentation - UPDATE](https://duckdb.org/docs/sql/statements/update)
