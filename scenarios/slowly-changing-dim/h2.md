...
> 参考资料:
> - [H2 Documentation - MERGE INTO](https://h2database.com/html/commands.html#merge_into)
> - [H2 Documentation - Data Types](https://h2database.com/html/datatypes.html)
> - [H2 Documentation - SELECT subquery in MERGE](https://h2database.com/html/commands.html#merge_into)
...
## MERGE ... KEY 语法是 H2 特有的简写形式，适合测试和原型开发

## H2 2.0+ 支持 SQL:2003 标准 MERGE 语法，推荐在生产环境中使用标准语法

## H2 的 IDENTITY 类型等价于 BIGINT AUTO_INCREMENT

## H2 日期运算使用 CURRENT_DATE - 1 而非 INTERVAL 语法（更简洁）

## 测试框架中 H2 常作为 PostgreSQL/MySQL 的替代
