...
--
-- 参考资料:
--   [1] Hologres Documentation - INSERT ON CONFLICT (UPSERT)
--       https://help.aliyun.com/document_detail/130408.html
--   [2] Hologres Documentation - Table Types
--       https://help.aliyun.com/document_detail/176116.html
--   [3] Hologres Documentation - DML
--       https://help.aliyun.com/document_detail/181551.html
--   [4] Hologres - PostgreSQL Compatibility
--       https://help.aliyun.com/document_detail/193895.html
...
-- ============================================================
-- 6. Hologres 注意事项与最佳实践
-- ============================================================

-- 1. Hologres 兼容 PostgreSQL 协议，支持 ON CONFLICT UPSERT
-- 2. Hologres 使用 CALL SET_TABLE_PROPERTY 设置分布键和聚簇键
-- 3. distribution_key 建议设置为 customer_id，确保同一客户在同一 shard
-- 4. Hologres 支持 Fixed Plan 优化路径，加速单行 UPSERT
