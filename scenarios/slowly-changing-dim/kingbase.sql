...
--
-- 参考资料:
--   [1] KingbaseES 文档 - SQL 语言参考
--       https://help.kingbase.com.cn/
--   [2] KingbaseES 文档 - INSERT ON CONFLICT
--       https://help.kingbase.com.cn/v8/developer/sql-reference/insert.html
--   [3] KingbaseES - PostgreSQL 兼容性
--       https://help.kingbase.com.cn/v8/developer/compatibility.html
...
-- ============================================================
-- 6. KingbaseES 注意事项与最佳实践
-- ============================================================

-- 1. KingbaseES 高度兼容 PostgreSQL 语法，包括 ON CONFLICT、CTE 等
-- 2. 支持 Oracle 兼容模式（通过 kingbase.conf 配置）
-- 3. KingbaseES 支持可写 CTE（WITH ... DML ... RETURNING），
