...
> 参考资料:
> - [ksqlDB Documentation - CREATE TABLE](https://docs.ksqldb.io/en/latest/developer-guide/ksqldb-reference/create-table/)
...
## SCD Type 2: 模拟历史版本（ksqlDB 不原生支持）
...
## ksqlDB 的 TABLE 自动实现 SCD Type 1: 每个 key 只保留最新值

## ksqlDB 不原生支持 SCD Type 2（版本化历史），需要在上游系统处理
