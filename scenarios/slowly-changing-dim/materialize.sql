...
--   [2] Materialize Documentation - INSERT
--       https://materialize.com/docs/sql/insert/
--   [3] Materialize Documentation - Subsources and Sources
--       https://materialize.com/docs/sql/create-source/
--   [4] Materialize - Incremental Computation
...
-- ============================================================
-- 5. Materialize 特色: 实时物化视图（增量计算 SCD）
-- ============================================================
...
-- ============================================================
-- 7. Materialize 注意事项与最佳实践
-- ============================================================

-- 1. Materialize 是流式数据库，核心优势是物化视图的增量维护
-- 2. 支持从 Kafka/PostgreSQL/MySQL 等外部 Source 导入数据
-- 3. SUBSCRIBE 提供实时变更推送（CDC 输出）
-- 4. Materialize 不支持可写 CTE，SCD Type 2 必须分步执行
-- 5. 对于流式 SCD Type 2，建议在 Materialize 之外处理版本化逻辑
-- 6. Materialize 的 INDEX 可加速维度表的点查找
