...
> 参考资料:
> - [openGauss Documentation - SQL Reference](https://docs.opengauss.org/)
...
## openGauss 兼容 PostgreSQL 的 ON CONFLICT 和可写 CTE

## openGauss 额外支持 MERGE INTO（Oracle 兼容扩展）

## 支持 行级 安全策略 (RLS)，可用于维度表权限控制:
