...
> - [Oracle Database Concepts - Flashback Technology](https://docs.oracle.com/en/database/oracle/oracle-database/23/cncpt/)
...
## SCD Type 1: 直接覆盖（MERGE，Oracle 9i 首创）
...
## Oracle Flashback: 替代 SCD 的历史数据查询
...
### MERGE 是 SCD 实现的核心 DML，Oracle 9i 首创，SQL:2003 标准化。
