...
--
-- 参考资料:
--   [1] Azure Synapse Analytics - Dedicated SQL Pool T-SQL
--       https://learn.microsoft.com/en-us/azure/synapse-analytics/sql/overview-features
--   [2] Azure Synapse - CTAS (CREATE TABLE AS SELECT)
--       https://learn.microsoft.com/en-us/sql/t-sql/statements/create-table-as-select-azure-synapse-analytics
--   [3] Azure Synapse - MERGE limitations
--       https://learn.microsoft.com/en-us/sql/t-sql/statements/merge-transact-sql#limitations-and-restrictions
