...
> 参考资料:
> - [TimescaleDB Documentation - Hypertable](https://docs.timescale.com/api/latest/hypertable/)
...
## SCD Type 2: 可写 CTE 版本化（PostgreSQL 最佳方式）
...
## TimescaleDB 注意事项与最佳实践


## TimescaleDB 是 PostgreSQL 扩展，100% 兼容 PostgreSQL 语法

## 维度表通常使用普通 PostgreSQL 表（非 Hypertable）

## 事实表使用 Hypertable，按时间自动分片

## 可写 CTE 让 SCD Type 2 成为单语句原子操作（PostgreSQL 独有）

## 查询维度时可利用 PostgreSQL 的范围类型:
