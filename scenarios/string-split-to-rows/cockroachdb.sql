-- CockroachDB: 将分隔字符串拆分为多行 (String Split to Rows)
--
-- 参考资料:
--   [1] CockroachDB Documentation - String Functions
--       https://www.cockroachlabs.com/docs/stable/functions-and-operators#string-and-byte-functions
--   [2] CockroachDB Documentation - UNNEST
--       https://www.cockroachlabs.com/docs/stable/functions-and-operators#array-functions
