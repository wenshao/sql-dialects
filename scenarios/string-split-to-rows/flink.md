...
> 参考资料:
> - [Flink Documentation - String Functions](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/functions/systemfunctions/#string-functions)
> - [Flink Documentation - UNNEST / Array Expansion](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/joins/#array-expansion)
> - [Flink Documentation - Table Functions](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/functions/udfs/#table-functions)
...
## CROSS JOIN UNNEST + STRING_TO_ARRAY（推荐, Flink 1.15+）
