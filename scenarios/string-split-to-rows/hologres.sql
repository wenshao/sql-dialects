...
--
-- 参考资料:
--   [1] Hologres Documentation - PostgreSQL 兼容
...
--   [3] Hologres SQL Reference - String Functions
--       https://help.aliyun.com/document_detail/102813.html
...
-- ============================================================
-- 2. STRING_TO_ARRAY + UNNEST（推荐，兼容 PostgreSQL）
-- ============================================================
...
-- ============================================================
-- 3. LATERAL + UNNEST + WITH ORDINALITY（保留序号）
-- ============================================================
