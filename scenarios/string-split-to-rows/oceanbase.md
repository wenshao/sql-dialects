...
> 参考资料:
> - [OceanBase Documentation - 字符串函数](https://www.oceanbase.com/docs/common-oceanbase-database-cn)
> - OceanBase 兼容 MySQL / Oracle 模式
...
## 方法 1: JSON_TABLE（MySQL 模式，OceanBase 4.x+）
