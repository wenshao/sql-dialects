...
--       https://docs.tdengine.com/taos-sql/
--   [2] TDengine Documentation - String Functions
--       https://docs.tdengine.com/taos-sql/function/#string-functions
--   [3] TDengine Documentation - UDF（用户自定义函数）
--       https://docs.tdengine.com/taos-sql/udf/
