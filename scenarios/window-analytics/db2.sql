...
--
-- 参考资料:
--   [1] IBM Db2 Documentation - OLAP Specifications
--       https://www.ibm.com/docs/en/db2/11.5?topic=expressions-olap-specifications
--   [2] IBM Db2 Documentation - Window Functions
--       https://www.ibm.com/docs/en/db2/11.5?topic=functions-aggregate
