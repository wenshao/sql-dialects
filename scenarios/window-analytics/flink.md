...
> 参考资料:
> - [Apache Flink Documentation - Over Aggregation](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/over-agg/)
> - [Apache Flink Documentation - Window Functions](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/window-agg/)
...
## LEAD / LAG（Flink 不直接支持传统 LAG/LEAD）
...
## 窗口 TVF（Table-Valued Function，Flink 1.13+）
