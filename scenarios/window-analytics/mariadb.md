...
> 参考资料:
> - [MariaDB Documentation - Window Functions (MariaDB 10.2+)](https://mariadb.com/kb/en/window-functions/)
> - [MariaDB Documentation - Window Frames](https://mariadb.com/kb/en/window-functions-overview/)
