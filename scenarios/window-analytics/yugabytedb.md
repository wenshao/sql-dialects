...
> 参考资料:
> - [YugabyteDB Documentation - Window Functions (YSQL)](https://docs.yugabyte.com/latest/api/ysql/exprs/window_functions/)
> - PostgreSQL Documentation (YSQL 兼容 PostgreSQL)
