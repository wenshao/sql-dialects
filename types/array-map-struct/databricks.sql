...
--
-- 参考资料:
--   [1] Databricks Documentation - Complex Types
--       https://docs.databricks.com/en/sql/language-manual/data-types/complex-types.html
--   [2] Databricks Documentation - Array Functions
--       https://docs.databricks.com/en/sql/language-manual/functions/array-functions.html
--   [3] Databricks Documentation - Map Functions
--       https://docs.databricks.com/en/sql/language-manual/functions/map-functions.html
