...
--
-- 参考资料:
--   [1] Apache Derby Documentation - Data Types
--       https://db.apache.org/derby/docs/10.16/ref/crefsqlj31068.html
...
-- 1. Derby 不支持 ARRAY / MAP / STRUCT 类型
-- 2. 不支持 JSON 数据类型或函数
-- 3. 不支持 XML 数据类型
-- 4. 使用关联表是最佳替代方案
-- 5. Derby 是嵌入式数据库，功能相对简单
