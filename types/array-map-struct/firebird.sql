...
--
-- 参考资料:
--   [1] Firebird Documentation - Array Data Type
--       https://firebirdsql.org/file/documentation/html/en/refdocs/fblangref40/firebird-40-language-reference.html#fblangref40-datatypes-array
...
-- 1. Firebird 支持原生 ARRAY 类型（固定维度）
-- 2. 数组大小在建表时确定，不能动态增长
-- 3. SQL 中不能直接构造数组字面量
-- 4. 没有 MAP / STRUCT / JSON 类型
-- 5. 没有 UNNEST / ARRAY_AGG 函数
-- 6. 数组功能相对有限，主要通过客户端 API 操作
