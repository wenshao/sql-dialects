-- Flink SQL: 复合/复杂类型 (Array, Map, Struct)
--
-- 参考资料:
--   [1] Flink Documentation - Data Types (ARRAY)
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/types/#array
--   [2] Flink Documentation - Data Types (MAP)
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/types/#map
--   [3] Flink Documentation - Data Types (ROW)
--       https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/types/#row
--   [4] Flink Documentation - Built-in Functions
...
-- 1. Flink SQL 原生支持 ARRAY、MAP、ROW
-- 2. 数组下标从 1 开始
-- 3. 许多数组/Map 函数从 Flink 1.15+ 开始添加
-- 4. COLLECT 是 Flink 的 ARRAY_AGG
-- 5. ROW 类型等价于 STRUCT
-- 6. 支持任意深度的嵌套
-- 7. JSON 格式自动映射复杂类型
