...
--
-- 参考资料:
--   [1] Greenplum Documentation - Array Types
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/ref_guide-data_types.html
--   [2] Greenplum Documentation - Composite Types
--       https://docs.vmware.com/en/VMware-Greenplum/7/greenplum-database/admin_guide-ddl-ddl-type.html
--   [3] PostgreSQL Documentation - Arrays (Greenplum 兼容)
