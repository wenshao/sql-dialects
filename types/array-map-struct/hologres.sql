...
-- 参考资料:
--   [1] Hologres 文档 - 数据类型
--       https://help.aliyun.com/document_detail/130660.html
--   [2] Hologres 文档 - JSON 和 JSONB
--       https://help.aliyun.com/document_detail/401513.html
...
-- 1. 兼容 PostgreSQL 的 ARRAY 类型
-- 2. 支持 JSONB 类型
-- 3. 不支持 PostgreSQL 复合类型（CREATE TYPE AS）
-- 4. 不支持 hstore
-- 5. 数组下标从 1 开始
