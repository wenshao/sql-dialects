...
> 参考资料:
> - [KingbaseES 文档 - 数据类型](https://help.kingbase.com.cn/v8/development/sql-plsql/sql/SQL_data_types.html)
...
## hstore 适合简单键值对，JSONB 适合嵌套结构

## Oracle 兼容模式支持 VARRAY / Nested Table

## 复合类型字段访问需要括号: (col).field

## 大数组可能触发 TOAST 溢出，性能需评估

## STRING_TO_ARRAY / ARRAY_TO_STRING 是字符串与数组互转的常用函数
