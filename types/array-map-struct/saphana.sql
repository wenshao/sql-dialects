...
--
-- 参考资料:
--   [1] SAP HANA SQL Reference - ARRAY Data Type
...
--       https://help.sap.com/docs/HANA_SERVICE_CF/7c78579ce9b14a669c1f3295b0d8ca16/3918498e41a44cbc9a4f4e5f41b29a23.html
...
-- 1. ARRAY 类型只能在 SQL Script（过程/函数）中使用
-- 2. 不能作为表列的数据类型
-- 3. 没有 MAP / STRUCT 表列类型
-- 4. 使用 JSON 字符串存储复杂结构
-- 5. JSON_TABLE 提供展开功能
