...
--
-- 参考资料:
--   [1] TimescaleDB Documentation - Data Types
--       https://docs.timescale.com/timescaledb/latest/overview/
--   [2] PostgreSQL Documentation - Arrays
...
-- 1. 完全继承 PostgreSQL 的 ARRAY / 复合类型 / JSONB / hstore
-- 2. 复杂类型列可以在 hypertable 中使用
-- 3. GIN 索引在 hypertable 上正常工作
-- 4. 连续聚合中可以使用 ARRAY_AGG
