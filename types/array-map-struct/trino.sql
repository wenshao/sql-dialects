-- Trino: 复合/复杂类型 (Array, Map, Struct/Row)
--
-- 参考资料:
--   [1] Trino Documentation - Array Type
--       https://trino.io/docs/current/language/types.html#array
--   [2] Trino Documentation - Map Type
--       https://trino.io/docs/current/language/types.html#map
--   [3] Trino Documentation - Row Type
--       https://trino.io/docs/current/language/types.html#row
--   [4] Trino Documentation - Array Functions
--       https://trino.io/docs/current/functions/array.html
--   [5] Trino Documentation - Map Functions
...
-- 1. Trino 原生支持 ARRAY、MAP、ROW
-- 2. 数组下标从 1 开始
-- 3. 支持高阶函数 (TRANSFORM, FILTER, REDUCE)
-- 4. UNNEST 是展开数组/Map 的标准方式
-- 5. ROW 类型等价于其他引擎的 STRUCT
-- 6. 支持任意深度的嵌套
