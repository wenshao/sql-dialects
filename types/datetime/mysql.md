...
> - [MySQL Internals - Data Type Storage Requirements](https://dev.mysql.com/doc/refman/8.0/en/storage-requirements.html)
...
## DATETIME vs TIMESTAMP: 内部存储和时区转换机制

### DATETIME: 字面值存储（无时区转换）
...
## 微秒精度的存储开销（Fractional Seconds Precision, FSP）
