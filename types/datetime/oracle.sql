...
-- ============================================================
-- 7. TIMESTAMP WITH LOCAL TIME ZONE（Oracle 独有）
-- ============================================================
...
-- 3. TIMESTAMP WITH LOCAL TIME ZONE 是优秀的设计: 存储 UTC、显示本地时间。
