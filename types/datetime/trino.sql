...
--   [2] Trino - Date and Time Functions
--       https://trino.io/docs/current/functions/datetime.html

-- DATE: 日期
-- TIME(p): 时间（无时区），精度 0~12
-- TIME WITH TIME ZONE: 时间（带时区偏移）
-- TIMESTAMP(p): 日期时间（无时区），精度 0~12
-- TIMESTAMP(p) WITH TIME ZONE: 日期时间（带时区），精度 0~12
