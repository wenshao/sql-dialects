-- Flink SQL: JSON Type (Flink 1.14+)
--
-- 参考资料:
...
-- Flink has no native JSON column type
-- JSON is handled as STRING or through structured types (ROW, ARRAY, MAP)

-- JSON as format (most common: Kafka with JSON format)
CREATE TABLE events (
    id         BIGINT,
    name       STRING,
    age        INT,
