...
--   [2] MySQL 8.0 Reference Manual - JSON Function Reference
--       https://dev.mysql.com/doc/refman/8.0/en/json-function-reference.html
--   [3] WL#8132 - JSON datatype and binary storage format
--       https://dev.mysql.com/worklog/task/?id=8132
--   [4] WL#8955 - Multi-Valued Indexes
...
-- 3.3 多值索引（Multi-Valued Index, 8.0.17+）
...
-- ============================================================
-- 6. 横向对比: 各引擎的 JSON 实现（对引擎开发者）
-- ============================================================

-- 6.1 PostgreSQL: JSON vs JSONB
...
-- 6.3 ClickHouse: Nested / Tuple / JSON (实验性)
