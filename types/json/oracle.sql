...
--
-- 参考资料:
--   [1] Oracle JSON Developer's Guide
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/adjsn/
--   [2] Oracle SQL Language Reference - JSON Functions
--       https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/JSON-Functions.html
...
-- ============================================================
-- 4. JSON_TABLE: 将 JSON 展开为关系表（Oracle 12c+ 的杀手级特性）
-- ============================================================
