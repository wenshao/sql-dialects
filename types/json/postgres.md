...
> - [PostgreSQL Source - jsonb.c / jsonb_gin.c](https://github.com/postgres/postgres/blob/master/src/backend/utils/adt/jsonb.c)

## JSON vs JSONB: 两种存储策略
