...
> 参考资料:
> - [Oracle SQL Language Reference - NUMBER Data Type](https://docs.oracle.com/en/database/oracle/oracle-database/23/sqlrf/Data-Types.html)

## NUMBER: Oracle 的"万能"数值类型
...
## BINARY_FLOAT / BINARY_DOUBLE（10g+，IEEE 754）
