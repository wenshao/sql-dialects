...
## utf8 vs utf8mb4: 字符集设计的历史教训（对引擎开发者）

### MySQL 的 "utf8" 只支持 BMP (Basic Multilingual Plane, U+0000 ~ U+FFFF)
...
## CHAR vs VARCHAR vs TEXT 的存储差异（InnoDB 行格式层面）
...
## COLLATION: 对索引和比较的引擎层影响

### 排序规则决定了索引中键的排列方式和相等性判定
