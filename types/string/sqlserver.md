...
> 参考资料:
> - [SQL Server T-SQL - char/varchar/nchar/nvarchar](https://learn.microsoft.com/en-us/sql/t-sql/data-types/char-and-varchar-transact-sql)

## 双轨字符串类型系统: VARCHAR vs NVARCHAR
...
## 排序规则（Collation）: SQL Server 独特的层级设计
